...
/**
 * Autopilot brand mark filled with the purple → teal brand gradient.
 * Uses the same gradient stops as `--ai-gradient-strong` so it matches
 * the gradient used on the chat send button, suggestion buttons, and title.
 *
...
AutopilotGradientIcon.displayName = "AutopilotGradientIcon";
