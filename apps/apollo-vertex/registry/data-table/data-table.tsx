...
declare module "@tanstack/react-table" {
  // oxlint-disable-next-line no-unused-vars -- TFeatures and TValue are required by the TanStack Table module augmentation signature
  interface ColumnMeta<TFeatures, TData extends RowData, TValue> {
    displayName?: string;
    getFilterValue?: (value: unknown, row: AppRow<TData>) => string;
...
interface DataTableProps<TData extends RowData> {
  ...
  globalFilterFn?: AppFilterFn<TData>;
  enableSearch?: boolean;
  enableViewOptions?: boolean;
  enableColumnResizing?: boolean;
  toolbarContent?: (table: AppTable<TData>) => React.ReactNode;
  noResultsMessage?: React.ReactNode;
  stickyHeader?: boolean;
  expanded?: ExpandedState;
  onExpandedChange?: OnChangeFn<ExpandedState>;
  renderExpandedRow?: (row: AppRow<TData>) => React.ReactNode;
