...
import { OnboardingTourDemoTrigger } from './onboarding-tour-demo';
...
```tsx
import { useOnboardingTour, isTourCompleted } from "@/components/ui/onboarding-tour";
...
```tsx
import { resetTourState } from "@/components/ui/onboarding-tour";
