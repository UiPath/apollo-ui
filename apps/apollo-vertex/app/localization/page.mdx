...
[https://engdogfood.staging.uipath.host/apollo-vertex/vertex-components/shell](https://engdogfood.staging.uipath.host/apollo-vertex/vertex-components/shell)

This brings in the `LocaleProvider` and updated shell components that support i18n out of the box. Language switching is integrated into the user profile dropdown.
