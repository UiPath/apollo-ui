...
<div className="p-4 border rounded-lg mt-4 flex flex-wrap gap-2">
  <Badge status="success"><Check /> Primary</Badge>
  <Badge status="success" variant="secondary"><Check /> Secondary</Badge>
  <Badge status="success" variant="outline"><Check /> Outline</Badge>
</div>
