...
import { TableChartWithAdapter } from "@uipath/apollo-vertex/charts";
import type { TableChartState } from "@uipath/apollo-vertex/charts";
import { dataFabricAdapter } from "@uipath/apollo-vertex/charts";
