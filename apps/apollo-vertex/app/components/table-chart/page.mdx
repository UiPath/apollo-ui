...
import { TableChartWithAdapter } from "@uipath/apollo-vertex";
import type { TableChartState } from "@uipath/apollo-vertex";
import { dataFabricAdapter } from "@uipath/apollo-vertex";
