    ...
    <div className="my-6 space-y-20">
      ...
      <section>
        ...
        <p className="mb-6 max-w-prose text-sm text-muted-foreground">
          ...
          primary glass card with the glow and a gradient fill
          badge to set it apart from the standard results.
        </p>
        <ProductGrid />
        <div className="mt-10 max-w-prose">
          ...
          <p className="text-sm text-muted-foreground">
            The glow lifts the recommended card off the grid, and
            the gradient fill badge names why it stands out. The two work as a
            pair: the glow draws the eye, the label explains the emphasis. Use
            the combination for a single best match per view so the signal stays
            meaningful, and keep the glow soft. It guides attention without the
            hard edge of a border or a solid color block.
          </p>
        </div>
      </section>
      ...
      <section>
        ...
        <p className="mb-6 max-w-prose text-sm text-muted-foreground">
          A card group over one shared glow, headed by the mark. Each card
          pairs an action with its impact metrics and offers to automate or
          dismiss it.
        </p>
        <RecommendedActions />
        <div className="mt-10 max-w-prose">
