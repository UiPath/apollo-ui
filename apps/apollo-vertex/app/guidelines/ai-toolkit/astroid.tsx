...
/**
 * The AI Identity mark: Lucide's `astroid` icon (v1.12.0), a four-pointed sharp
 * star. Inlined verbatim because the installed lucide-react (0.577.0) predates it.
 * Behaves like any Lucide icon: outline via stroke, or filled via fill (set
 * strokeWidth 0); either takes a solid color (currentColor) or a gradient (url).
 */
