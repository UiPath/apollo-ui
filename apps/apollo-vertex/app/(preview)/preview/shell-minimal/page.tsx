...
import { LoanQcDashboard } from "@/templates/shell/LoanQcDashboard";
...
export default function ShellMinimalPreviewPage() {
  ...
  return (
    ...
    >
      ...
      >
        <LoanQcDashboard
          visible={contentVisible && activePage === "dashboard"}
        />
        <ProjectsPage visible={contentVisible && activePage === "projects"} />
        <AnalyticsPage
          visible={activePage === "invoices" || activePage === "analytics"}
        />
      </ShellTemplate>
    </ShellNavigationProvider>
  );
