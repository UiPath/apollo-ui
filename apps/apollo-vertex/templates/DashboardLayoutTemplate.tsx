          ...
          >
            ...
            <div
              ...
              style={{
                ...
                opacity: isInputFocused ? 1 : 0,
                transition: isInputFocused
                  ? "opacity 600ms ease-in-out 100ms"
                  : "opacity 100ms ease-in-out 0ms",
              }}
            />
            ...
            <div
              ...
              style={{
                ...
                opacity: isInputFocused ? 1 : 0,
                transition: isInputFocused
                  ? "opacity 600ms ease-in-out 150ms"
                  : "opacity 100ms ease-in-out 0ms",
              }}
            />
          </div>
                  ...
                  <div className="flex flex-col gap-6 h-full">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        Track completion rates and pending reviews across all
                        loan documents
                      </p>
                    </div>
                  ...
                  <div className="flex flex-col gap-6 h-full">
                    ...
                    <div className="grid grid-cols-4 gap-4">
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <span className="text-xs text-muted-foreground">
                          {cardData.targetScore - cardData.qualityScore} points
                          to go
                        </span>
                      </div>
                      <div className="flex flex-col gap-1">
              ...
              >
                {viewState === "skeleton" ? (
                  ...
                  >
                    ...
                    <TrendChart
                      data={[
                        72, 72.5, 73, 73.2, 73.8, 74, 74.5, 74.8, 75.2, 75.5,
                        76, 76.2, 76.5, 76.8, 77,
                      ]}
