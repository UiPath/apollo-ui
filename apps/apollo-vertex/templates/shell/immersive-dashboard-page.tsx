...
import { GradientBars } from "@/templates/components/GradientBars";
import { UserActivityBars } from "@/templates/components/UserActivityBars";
import { DonutChart } from "@/templates/components/DonutChart";
import { Sparkline } from "@/templates/components/Sparkline";
import { TrendChart } from "@/templates/components/TrendChart";

interface ImmersiveDashboardPageProps {
  visible: boolean;
  onBackgroundModeChange?: (mode: string) => void;
}

export function ImmersiveDashboardPage({
  visible,
  onBackgroundModeChange,
}: ImmersiveDashboardPageProps) {
  ...
  const [heroContent, setHeroContent] = useState({
    ...
    subheadline:
      "12,120 invoices process with 77% touch-less automation and an average posting time of 2.8 days. SLA risk remains low",
  });
  ...
  const [issueBreakdown, setIssueBreakdown] = useState([
    {
      ...
      percentage: 85,
      gradient: "#9875FF",
      shadowColor: "rgba(152, 117, 255, 0.4)",
    },
    {
      label: "Incomplete data fields",
      percentage: 65,
      gradient: "#D582E3",
      shadowColor: "rgba(213, 130, 227, 0.4)",
    },
    {
      label: "Quality check failures",
      percentage: 45,
      gradient: "#EE77A2",
      shadowColor: "rgba(238, 119, 162, 0.4)",
    },
    {
      label: "Processing delays",
      percentage: 60,
      gradient: "#FFC775",
      shadowColor: "rgba(255, 199, 117, 0.4)",
    },
  ]);
  ...
  const [alertBreakdown, setAlertBreakdown] = useState([
    {
      label: "Critical - Regulatory violations",
      percentage: 22,
      gradient: "#EF4444",
      shadowColor: "rgba(239, 68, 68, 0.4)",
    },
    {
      label: "High - Missing required docs",
      percentage: 35,
      gradient: "#F97316",
      shadowColor: "rgba(249, 115, 22, 0.4)",
    },
    {
      label: "Medium - Data inconsistencies",
      percentage: 52,
      gradient: "#F59E0B",
      shadowColor: "rgba(245, 158, 11, 0.4)",
    },
    {
      label: "Low - Minor discrepancies",
      percentage: 78,
      gradient: "#FBBF24",
  ...
  const generateNewData = () => {
    const automationChange = Math.floor(Math.random() * 10) - 2;
    const cycleChange = Math.floor(Math.random() * 20) + 5;
    ...
    setCardTitles({
      card1:
        titleOptions.card1[
          Math.floor(Math.random() * titleOptions.card1.length)
        ],
      card2:
        titleOptions.card2[
          Math.floor(Math.random() * titleOptions.card2.length)
        ],
      card3:
        titleOptions.card3[
          Math.floor(Math.random() * titleOptions.card3.length)
        ],
      card4:
        titleOptions.card4[
          Math.floor(Math.random() * titleOptions.card4.length)
        ],
    });
    ...
    setExtractionPerformance([
      {
        ...
        percentage: Math.floor(Math.random() * 8) + 92,
        color: "rgb(6, 182, 212)",
        shadowColor: "rgba(6, 182, 212, 0.4)",
      },
      {
        ...
        percentage: Math.floor(Math.random() * 8) + 90,
        color: "rgb(6, 182, 212)",
        shadowColor: "rgba(6, 182, 212, 0.4)",
      },
      {
        ...
        percentage: Math.floor(Math.random() * 8) + 88,
        color: "rgb(6, 182, 212)",
        shadowColor: "rgba(6, 182, 212, 0.4)",
      },
      {
        name: generateRandomName(),
        avatar: shuffledAvatars[3],
        percentage: Math.floor(Math.random() * 8) + 86,
        color: "rgb(6, 182, 212)",
        shadowColor: "rgba(6, 182, 212, 0.4)",
      },
    ]);
    ...
    <>
      ...
      <div className="flex h-full flex-col gap-6 p-6 relative">
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-xs">
              <span className="font-bold">UiPath&trade;</span> Vertical
              Solutions
            </p>
          ...
          <div className="flex items-center gap-4">
            ...
            <Select
              ...
              onValueChange={(v) => onBackgroundModeChange?.(v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
        ...
        <div className="grid flex-1 grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4 lg:grid-rows-2 relative">
          ...
          {viewState === "empty" && (
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 z-40">
              ...
              <Button onClick={() => setViewState("default")} className="mt-2">
                View Sample Data
              </Button>
            </div>
          )}
          ...
          {expandedCard && (
            <Card
              className="absolute top-0 bottom-0 right-0 gap-1 rounded-md border-0 bg-accent-foreground/6 p-6 shadow-none overflow-y-auto z-50"
              style={{
                left: "calc(50% + 0.5rem)",
                ...
                <div className="flex flex-col gap-6 h-full">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Track completion rates and pending reviews across all loan
                      documents
                    </p>
                  </div>
                  <div className="grid grid-cols-4 gap-4">
                    <div className="flex flex-col gap-1">
                      ...
                      <span className="text-2xl font-bold text-foreground">
                        {cardData.totalDocs.toLocaleString()}
                      </span>
              ...
              {expandedCard === "card2" && (
                <div className="flex flex-col gap-6 h-full">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Monitor extraction accuracy and processing speed for
                      automated checks
                    </p>
                  </div>
                  <div className="grid grid-cols-4 gap-4">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <span className="text-2xl font-bold text-foreground">
                        {cardData.docsProcessed.toLocaleString()}
                      </span>
                      <span className="text-xs text-green-500">
                        +24% this month
                      </span>
              ...
              {expandedCard === "card3" && (
                <div className="flex flex-col gap-6 h-full">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Overall quality metrics and performance indicators across
                      all processes
                    </p>
                  </div>
                  <div className="grid grid-cols-4 gap-4">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <span className="text-2xl font-bold text-foreground">
                        {cardData.targetScore}
                      </span>
                      <span className="text-xs text-muted-foreground">
                        {cardData.targetScore - cardData.qualityScore} points to
                        go
                      </span>
                    </div>
                    <div className="flex flex-col gap-1">
              ...
              {expandedCard === "card4" && (
                <div className="flex flex-col gap-6 h-full">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Monitor regulatory compliance and critical alerts
                      requiring attention
                    </p>
                  </div>
                  <div className="grid grid-cols-4 gap-4">
                  ...
                  <div className="flex items-center justify-end gap-2">
                    ...
                    <Button size="sm">Resolve issues</Button>
                  </div>
                </div>
              )}
            </Card>
          ...
          <div
            ...
            style={{
              ...
              transition:
                viewState === "skeleton"
                  ? "none"
                  : `opacity ${fadingFromSkeleton ? "150ms" : "400ms"} ease-in-out 0ms, transform ${fadingFromSkeleton ? "150ms" : "400ms"} ease-in-out 0ms`,
            }}
          >
            {/* Hero Card */}
            <Card
              ...
              style={{
                background:
                  "linear-gradient(152.44deg, rgba(13, 14, 36, 0.95) 2.42%, rgba(37, 27, 40, 0) 43.21%), linear-gradient(227.57deg, rgba(91, 31, 112, 0.4) 10.36%, rgba(251, 70, 22, 0.4) 147.71%), rgba(228, 237, 245, 0.06)",
              }}
            >
              {viewState === "skeleton" ? (
                <>
                ...
                <div
                  ...
                  style={{
                    ...
                    animation: fadingFromSkeleton
                      ? "fadeIn 150ms ease-in-out 0ms forwards"
                      : "none",
                  }}
                >
                  ...
                  <TrendChart
                    data={[
                      72, 72.5, 73, 73.2, 73.8, 74, 74.5, 74.8, 75.2, 75.5, 76,
                      76.2, 76.5, 76.8, 77,
                    ]}
          ...
          <Card
            ...
            className="lg:min-h-[200px] gap-1 rounded-md border-0 p-6 shadow-none cursor-pointer group bg-accent-foreground/6 hover:bg-accent-foreground/9"
            style={{
              opacity:
                viewState === "error" || viewState === "empty"
                  ? 0
              ...
              transition:
                viewState === "skeleton"
                  ? "none"
                  : `opacity ${fadingFromSkeleton ? "150ms" : "400ms"} ease-in-out ${fadingFromSkeleton ? "50ms" : "25ms"}, transform ${fadingFromSkeleton ? "150ms" : "400ms"} ease-in-out ${fadingFromSkeleton ? "50ms" : "25ms"}`,
            }}
          >
            ...
            {viewState === "skeleton" ? (
                  ...
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="flex flex-col gap-2">
                      ...
                      <div className="h-1 w-full rounded-full bg-accent-foreground/10">
                        <div
                          className="h-1 rounded-full bg-foreground/20 animate-pulse"
                          style={{ width: `${80 - i * 10}%` }}
                        />
                      </div>
                    </div>
              ...
              <div
                ...
                style={{
                  opacity: fadingFromSkeleton ? 0 : 1,
                  animation: fadingFromSkeleton
                    ? "fadeIn 150ms ease-in-out 50ms forwards"
                    : "none",
                }}
              >
                <h3 className="text-left text-base font-bold text-foreground">
          ...
          <Card
            onClick={() =>
              setExpandedCard(expandedCard === "card2" ? null : "card2")
            }
            className="lg:min-h-[200px] gap-1 rounded-md border-0 p-6 shadow-none cursor-pointer group bg-accent-foreground/6 hover:bg-accent-foreground/9"
            style={{
              opacity:
              ...
              transition:
                viewState === "skeleton"
                  ? "none"
                  : `opacity ${fadingFromSkeleton ? "150ms" : "400ms"} ease-in-out ${fadingFromSkeleton ? "100ms" : "50ms"}, transform ${fadingFromSkeleton ? "150ms" : "400ms"} ease-in-out ${fadingFromSkeleton ? "100ms" : "50ms"}`,
            }}
          >
            <ArrowUpRight className="absolute top-7 right-6 size-4 text-foreground opacity-0 translate-x-2 transition-all group-hover:opacity-100 group-hover:translate-x-0" />
            {viewState === "skeleton" ? (
              ...
              <div
                ...
                style={{
                  opacity: fadingFromSkeleton ? 0 : 1,
                  animation: fadingFromSkeleton
                    ? "fadeIn 150ms ease-in-out 100ms forwards"
                    : "none",
                }}
              >
                <h3 className="text-left text-base font-bold text-foreground">
                ...
                <p className="text-xs text-muted-foreground">
                  Monitor extraction accuracy and processing speed for automated
                  checks
                </p>
                <UserActivityBars users={extractionPerformance} />
              </div>
          ...
          <Card
            onClick={() =>
              setExpandedCard(expandedCard === "card3" ? null : "card3")
            }
            className="lg:min-h-[200px] gap-1 rounded-md border-0 p-6 pb-4 shadow-none flex flex-col cursor-pointer group bg-accent-foreground/6 hover:bg-accent-foreground/9"
            style={{
              opacity:
                viewState === "error" || viewState === "empty"
                  ? 0
              ...
              transition:
                viewState === "skeleton"
                  ? "none"
                  : `opacity ${fadingFromSkeleton ? "150ms" : "400ms"} ease-in-out ${fadingFromSkeleton ? "150ms" : "75ms"}, transform ${fadingFromSkeleton ? "150ms" : "400ms"} ease-in-out ${fadingFromSkeleton ? "150ms" : "75ms"}`,
            }}
          >
            <ArrowUpRight className="absolute top-7 right-6 size-4 text-foreground opacity-0 translate-x-2 transition-all group-hover:opacity-100 group-hover:translate-x-0" />
            {viewState === "skeleton" ? (
              ...
              <div
                ...
                style={{
                  opacity: fadingFromSkeleton ? 0 : 1,
                  animation: fadingFromSkeleton
                    ? "fadeIn 150ms ease-in-out 150ms forwards"
                    : "none",
                }}
              >
                <h3 className="text-left text-base font-bold text-foreground">
          ...
          <Card
            onClick={() =>
              setExpandedCard(expandedCard === "card4" ? null : "card4")
            }
            className="lg:min-h-[200px] gap-1 rounded-md border-0 p-6 pb-4 shadow-none flex flex-col cursor-pointer group bg-accent-foreground/6 hover:bg-accent-foreground/9"
            style={{
              opacity:
              ...
              transition:
                viewState === "skeleton"
                  ? "none"
                  : `opacity ${fadingFromSkeleton ? "150ms" : "400ms"} ease-in-out ${fadingFromSkeleton ? "200ms" : "100ms"}, transform ${fadingFromSkeleton ? "150ms" : "400ms"} ease-in-out ${fadingFromSkeleton ? "200ms" : "100ms"}`,
            }}
          >
            <ArrowUpRight className="absolute top-7 right-6 size-4 text-foreground opacity-0 translate-x-2 transition-all group-hover:opacity-100 group-hover:translate-x-0" />
            {viewState === "skeleton" ? (
              ...
              <div
                ...
                style={{
                  opacity: fadingFromSkeleton ? 0 : 1,
                  animation: fadingFromSkeleton
                    ? "fadeIn 150ms ease-in-out 200ms forwards"
                    : "none",
                }}
              >
                <h3 className="text-left text-base font-bold text-foreground">
