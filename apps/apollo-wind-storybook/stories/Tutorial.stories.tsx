...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Learn Apollo Wind by building a registration form step by step. Each story explains how Apollo Design System tokens map to Tailwind utilities.',
      },
    },
  },
};
    ...
    <div className="bg-surface min-h-screen p-8">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="card card-elevated p-6 max-w-md mx-auto">
          <div className="mb-6">
            <h2 className="text-foreground-emp text-h3 mb-1">Create Account</h2>
            <p className="text-foreground-de-emp text-l">Join thousands of users worldwide</p>
          </div>
          ...
          <form>
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                <svg
                  className="icon-sm text-foreground-de-emp absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
            ...
            <div className="flex gap-2">
              <button type="submit" className="btn btn-primary-colors flex-1">
                Create Account
              </button>
              <button
                type="button"
                className="btn btn-tall text-foreground-emp border border-border hover:bg-background-hover"
              >
                Cancel
              </button>
            </div>
        ...
        <div className="text-foreground mt-8 p-4 bg-surface-raised rounded">
          ...
          <ul className="text-l text-foreground-de-emp space-y-1 list-disc list-inside">
            <li>How Apollo Design System tokens map to Tailwind utilities</li>
            <li>
              Component utilities like <code className="text-primary">card</code>,{' '}
              <code className="text-primary">btn</code>, and{' '}
              <code className="text-primary">input</code>
            </li>
            <li>
              Spacing system: <code className="text-primary">p-6</code> uses Apollo tokens, not
              Tailwind defaults
            </li>
            <li>
              Typography shortcuts: <code className="text-primary">text-h3</code>,{' '}
              <code className="text-primary">text-m</code>,{' '}
              <code className="text-primary">text-s</code>
            </li>
            <li>
              Semantic colors: <code className="text-primary">text-foreground-emp</code>,{' '}
...
export const Story2_CardAndSpacing: Story = {
    ...
    <div className="bg-surface min-h-screen p-8">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-foreground mb-6">
          ...
          <p className="text-l text-foreground-de-emp">
            Learn how component utilities work and how Apollo tokens map to Tailwind spacing
            utilities.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="card p-6 mb-4">
              ...
              <p className="text-l text-foreground-de-emp">
                Uses <code className="text-primary">card</code> utility with{' '}
                <code className="text-primary">p-6</code> padding.
              </p>
            </div>
            ...
            <div className="mt-6 bg-surface-raised p-4 rounded">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <pre className="bg-surface text-foreground p-3 rounded text-sm overflow-x-auto">
                    {`<div class="card p-6">
  <h4>Basic Card</h4>
  <p>Content here...</p>
</div>`}
            ...
            <div className="card p-4 mt-6">
              ...
              <div className="space-y-3">
                <div className="card p-2">
                  <code className="text-l text-foreground">p-2</code> → 8px (spacing-xs)
                </div>
                <div className="card p-4">
                  <code className="text-l text-foreground">p-4</code> → 16px (spacing-base)
                </div>
                <div className="card p-6">
                  <code className="text-l text-foreground">p-6</code> → 24px (spacing-l)
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-surface-raised p-6 rounded">
            ...
            <div className="space-y-6 text-foreground">
              ...
              <div>
                ...
                <p className="text-l text-foreground-de-emp mb-2">
                  <code className="text-primary">card</code> is a <strong>component utility</strong>{' '}
                  from Apollo Wind, added via Tailwind plugin. It sets multiple properties at once:
                </p>
                <pre className="bg-surface text-foreground p-3 rounded text-sm overflow-x-auto">
                  {`@utility card {
  ...
  border-radius: 3px;
                ...
                <p className="text-l text-foreground-de-emp mt-2">
                  <code className="text-primary">card-elevated</code> adds shadow on top of{' '}
              ...
              <div>
                ...
                <p className="text-l text-foreground-de-emp mb-3">
                  When you write <code className="text-primary">p-6</code>, here's what happens:
                </p>

                <div className="bg-surface text-foreground p-4 rounded space-y-2 text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <code className="text-primary bg-surface-raised px-2 py-1 rounded">
                      --spacing-6
                    </code>
                  </div>
              ...
              <div className="bg-info p-4 rounded border-l-4 border-info-600">
                <p className="text-l text-foreground-emp mb-1">
                  <strong>Key Insight</strong>
                </p>
                <p className="text-l text-foreground-de-emp">
                  You're NOT using Tailwind's default spacing!{' '}
                  <code className="text-primary">p-6</code> uses Apollo's{' '}
                  <code className="text-primary">--spacing-l</code> token (24px), ensuring
                  consistency across all UiPath products.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="bg-surface text-foreground p-3 rounded text-sm space-y-1">
          ...
          <div>
            ...
            <div className="card card-elevated p-6">
              ...
              <div className="bg-surface-raised p-4 rounded">
                <p className="text-l text-foreground-de-emp">
                  This header uses Apollo typography shortcuts:
                  <br />• <code className="text-primary">text-h3</code> for the heading
                  <br />• <code className="text-primary">text-s</code> for the subtitle
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 bg-surface-raised p-4 rounded">
              ...
              <div className="space-y-3">
                <div>
                  <p className="text-m text-foreground-de-emp mb-1">Card Header with Typography:</p>
                  <pre className="bg-surface text-foreground p-3 rounded text-sm overflow-x-auto">
                    {`<div class="card card-elevated p-6">
  <h2 class="text-foreground-emp text-h3 mb-1">
    Create Account
  </h2>
  <p class="text-foreground-de-emp text-s">
    Join thousands of users worldwide
            ...
            <div className="bg-surface-raised p-6 rounded mt-4">
              <h4 className="text-l text-foreground-emp mb-3">Typography Scale</h4>
              <div className="space-y-3">
                <div>
                  <span className="text-h1 text-foreground">text-h1</span>
                  <span className="text-sm text-foreground-de-emp ml-2">(36px / 44px)</span>
                </div>
                <div>
                  <span className="text-h2 text-foreground">text-h2</span>
                  <span className="text-sm text-foreground-de-emp ml-2">(28px / 36px)</span>
                </div>
                <div>
                  <span className="text-h3 text-foreground">text-h3</span>
                  <span className="text-sm text-foreground-de-emp ml-2">(24px / 32px)</span>
                </div>
                <div>
                  <span className="text-l text-foreground">text-m</span>
                  <span className="text-sm text-foreground-de-emp ml-2">(14px / 20px)</span>
                </div>
                <div>
                  <span className="text-l text-foreground">text-s</span>
                  <span className="text-sm text-foreground-de-emp ml-2">(12px / 16px)</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-surface-raised p-6 rounded">
            ...
            <div className="space-y-6 text-foreground">
              ...
              <div>
                <h4 className="text-l text-foreground-emp mb-2">1. Typography Shortcuts</h4>
                <p className="text-l text-foreground-de-emp mb-2">
                  Apollo Wind provides <strong>composite typography utilities</strong> that use
                  Apollo Core CSS variables (not hardcoded pixels):
                </p>
                <pre className="bg-surface text-foreground p-3 rounded text-xs overflow-x-auto">
                  {`@utility text-h3 {
  font-family: var(--font-header-3-family);
  font-size: var(--font-header-3-size);
  line-height: var(--font-header-3-line-height);
  font-weight: var(--font-header-3-weight);
}`}
                </pre>
                <p className="text-l text-foreground-de-emp mt-2">
                  Instead of writing{' '}
                  <code className="text-primary">text-2xl font-semibold leading-8</code>, use{' '}
              ...
              {/* Token Mapping */}
              <div>
                <h4 className="text-l text-foreground-emp mb-2">2. Apollo to Tailwind Mapping</h4>
                <p className="text-l text-foreground-de-emp mb-3">
                  <strong>Apollo Core CSS variable names</strong> (from{' '}
                  <code className="text-primary">@uipath/apollo-core</code>) map to Apollo Wind
                  utility class names:
                </p>

                <div className="bg-surface text-foreground p-4 rounded space-y-3 text-sm">
                  <div>
                    <div className="text-primary font-semibold mb-1">Headers</div>
                    <div className="space-y-1 text-foreground-de-emp">
                      <div>
                  ...
                  <div>
                    <div className="text-primary font-semibold mb-1">Body Text</div>
                    <div className="space-y-1 text-foreground-de-emp">
                      <div>
                        <code>--font-l-size/weight</code> →{' '}
                        <code className="text-primary">text-l</code>
                      </div>
                      <div>
                        <code>--font-m-size/weight</code> →{' '}
                        <code className="text-primary">text-m</code>
                      </div>
                      <div>
                        <code>--font-s-size/weight</code> →{' '}
                        <code className="text-primary">text-s</code>
                      </div>
                    </div>
                  </div>
              ...
              {/* Semantic Colors */}
              <div>
                <h4 className="text-l text-foreground-emp mb-2">3. Semantic Color Utilities</h4>
                <p className="text-l text-foreground-de-emp mb-2">
                  Semantic color utilities follow this mapping chain:
                </p>

                <div className="bg-surface text-foreground p-4 rounded space-y-4 text-sm">
                  {/* Mapping Chain Example */}
                  <div>
                    <div className="text-primary font-semibold mb-2">
                      Example: text-foreground-emp
                    </div>
                    <div className="space-y-1 text-foreground-de-emp">
                      <div>
                        1. <strong>Apollo Core variable:</strong>{' '}
                        <code>--color-foreground-emp</code>
                      </div>
                      <div>
                        2. <strong>Theme-specific value:</strong>
                      </div>
                      <div className="ml-4">
                        • Light: <code>#182027</code> (dark gray)
                      </div>
                      <div className="ml-4">
                        • Dark: <code>#f5f6fa</code> (light gray)
                      </div>
                      <div>
                        3. <strong>Apollo Wind utility:</strong>{' '}
                        <code className="text-primary">text-foreground-emp</code>
                      </div>
                      <div>
                        4. <strong>Result:</strong>{' '}
                        <span className="text-foreground-emp">
                          Emphasized text (adapts to theme)
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* All Semantic Colors */}
                  <div>
                    <div className="text-primary font-semibold mb-2">All Semantic Text Colors</div>
                    <div className="space-y-2">
                      <div className="flex justify-between items-center">
                        <code>text-foreground-emp</code>
                        <span className="text-foreground-emp">Emphasized</span>
                      </div>
                      <div className="flex justify-between items-center">
                      ...
                      <div className="flex justify-between items-center">
                        <code>text-foreground-de-emp</code>
                        <span className="text-foreground-de-emp">De-emphasized</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div>
              ...
              <div className="card card-elevated p-6">
                ...
                <form onSubmit={handleSubmit}>
                  <div className="mb-4">
                    <label className="block text-foreground-emp text-s mb-1">Email</label>
                ...
                {showSuccess && (
                  <div className="bg-success border-l-4 border-success-600 p-4 mt-4 rounded">
                    <div className="flex items-start gap-3">
                      <svg
                        className="icon-md text-success flex-shrink-0"
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke="currentColor"
                      >
                      ...
                      <div>
                        <p className="text-l text-foreground-emp font-semibold">Account created!</p>
                        <p className="text-l text-foreground-de-emp">Welcome to the platform.</p>
                      </div>
                    </div>
                  </div>
                )}
              ...
              <div className="mt-6 bg-surface-raised p-4 rounded">
                ...
                <div className="space-y-3">
                  <div>
                    <p className="text-m text-foreground-de-emp mb-1">
                      Primary Button with Success Message:
                    </p>
                    <pre className="bg-surface text-foreground p-3 rounded text-sm overflow-x-auto">
                      {`<button class="btn btn-primary-colors w-full">
  Create Account
</button>

<div class="alert alert-success">
  <p class="hover:text-foreground-emp">
    Account created!
  </p>
</div>`}
                    </pre>
                  ...
                  <div>
                    ...
                    <pre className="bg-surface text-foreground p-3 rounded text-sm overflow-x-auto">
                      {`<button class="btn btn-tall text-foreground-emp border border-border hover:bg-background-hover">
  Cancel
</button>`}
                    </pre>
                    <p className="text-xs text-foreground-de-emp mt-2">
                      <strong>hover:bg-background-hover</strong> maps to{' '}
                      <code>--color-background-hover</code>, providing a subtle gray hover state
              ...
              {/* Button Variants */}
              <div className="bg-surface-raised p-6 rounded mt-4">
                <h4 className="text-l text-foreground-emp mb-3">Button States</h4>
                <div className="flex flex-wrap gap-2">
                  <button className="btn btn-primary-colors">Primary Button</button>
                  <button className="btn">Default Button</button>
                  <button className="btn btn-small btn-primary-colors">Small Button</button>
                  <button className="btn btn-tall text-foreground-emp border border-border hover:bg-background-hover">
                    Cancel
                  </button>
            ...
            <div className="bg-surface-raised p-6 rounded">
              ...
              <div className="space-y-6 text-foreground">
                {/* Button Base */}
                <div>
                  <h4 className="text-l text-foreground-emp mb-2">
                    1. The <code className="text-primary">btn</code> Utility
                  </h4>
                  <p className="text-l text-foreground-de-emp mb-2">
                    The <code className="text-primary">btn</code> utility combines Apollo Design
                    System specifications with Apollo Core theme variables:
                  </p>
                  <pre className="bg-surface text-foreground p-3 rounded text-xs overflow-x-auto">
                    {`@utility btn {
  display: inline-flex;
  ...
  height: 40px;           /* Apollo Design Spec */
  padding-inline: 16px;   /* Apollo Design Spec */
  font-weight: 600;       /* Apollo Design Spec */
  font-size: 0.875rem;    /* Apollo Design Spec: 14px */
  border-radius: 3px;     /* Apollo Design Spec */
  transition: 200ms ease-in-out;

  &:focus-visible {
    /* Apollo Core CSS Variable */
  ...
  &:disabled {
    ...
    cursor: not-allowed;
                  ...
                  <p className="text-xs text-foreground-de-emp mt-2">
                    The measurements (40px height, 16px padding, etc.) come from Apollo Design
                    System specifications. The focus indicator color uses{' '}
                    <code>--color-focus-indicator</code>
                ...
                <div>
                  <h4 className="text-l text-foreground-emp mb-2">
                    2. <code className="text-primary">btn-primary-colors</code> Mapping
                  </h4>
                  <p className="text-l text-foreground-de-emp mb-3">
                  ...
                  <div className="bg-surface text-foreground p-4 rounded space-y-3 text-sm">
                      ...
                      <div className="space-y-2">
                        <div className="border-l-2 border-primary pl-3">
                          ...
                          <div className="text-foreground-de-emp">
                            <code>--color-primary</code> → <code>primary</code> →{' '}
                            <code className="text-primary">bg-primary</code>
                          </div>
                        </div>
                        ...
                        <div className="border-l-2 border-primary pl-3">
                          ...
                          <div className="text-foreground-de-emp">
                            <code>--color-primary-foreground-inverse</code> →{' '}
                            <code>primary-inverse</code> →{' '}
                            <code className="text-primary">text-primary-inverse</code>
                          </div>
                        </div>
                        ...
                        <div className="border-l-2 border-primary pl-3">
                          ...
                          <div className="text-foreground-de-emp">
                            <code>--color-primary-hover</code> → <code>primary-hover</code> →{' '}
                            <code className="text-primary">hover:bg-primary-hover</code>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="pt-3 border-t border-border">
                      ...
                      <pre className="bg-surface-raised text-foreground p-2 rounded overflow-x-auto">
  ...
  &:hover {
    background: var(--color-primary-hover);
                ...
                <div>
                  <h4 className="text-l text-foreground-emp mb-2">
                    3. Breaking Down <code className="text-primary">hover:text-foreground-emp</code>
                  </h4>
                  <p className="text-l text-foreground-de-emp mb-3">
                  ...
                  <div className="bg-surface text-foreground p-4 rounded space-y-3 text-sm">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-foreground-de-emp">
                          Applies styles on <code>:hover</code> pseudo-class. This is Tailwind's
                          variant system.
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-foreground-de-emp">
                          Maps to <code>var(--color-foreground-emp)</code> which resolves
  ...
  color: var(--color-foreground-emp);
                ...
                <div className="bg-warning p-4 rounded border-l-4 border-warning-600">
                  <p className="text-l text-foreground-emp mb-1">
                    <strong>Powerful Combination</strong>
                  </p>
                  <p className="text-l text-foreground-de-emp">
                    You get Tailwind's <strong>variant system</strong> (hover, focus, active)
                    combined with Apollo's <strong>semantic tokens</strong> (foreground-emp,
                    primary, success). The colors adapt to theme changes automatically!
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="bg-surface min-h-screen p-8">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-foreground mb-6">
            ...
            <p className="text-l text-foreground-de-emp">
              Learn about input utilities, validation states, and combining Apollo Wind with
              JavaScript.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="card card-elevated p-6">
                {/* Header Section */}
                <div className="mb-6">
                  <h2 className="text-foreground-emp text-h3 mb-1">Interactive Form Demo</h2>
                  <p className="text-foreground-de-emp text-l">
                    See how input utilities work with validation states
                  </p>
                </div>
                {/* Full Name Input */}
                <div className="mb-4">
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="email"
                      id="form-email"
                      className={`input pl-12 pr-10 ${isValid === true ? 'input-success' : isValid === false ? 'input-error' : ''}`}
                      placeholder="Enter your email"
                      value={email}
                    ...
                    {isValid === true && (
                      <svg
                        className="icon-sm text-success absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none"
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke="currentColor"
                      >
                    ...
                    {isValid === false && (
                      <svg
                        className="icon-sm text-error absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none"
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke="currentColor"
                      >
              ...
              <div className="mt-6 bg-surface-raised p-4 rounded">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <pre className="bg-surface text-foreground p-3 rounded text-sm overflow-x-auto">
                      {`<div class="relative">
  <svg class="icon-sm absolute left-3 top-1/2 -translate-y-1/2">
    <!-- icon path -->
  </svg>
  <input
    type="email"
    class="input input-success pl-12 pr-10"
    placeholder="Enter your email"
  />
</div>`}
                    </pre>
                    <p className="text-xs text-foreground-de-emp mt-2">
                      Use <strong>pl-12</strong> for inputs with left icons to provide spacing (icon
                      at 12px + 18px width + 12px gap).
                    </p>
                  </div>
                  <div>
                    <p className="text-m text-foreground-de-emp mb-1">Password Toggle:</p>
                    <pre className="bg-surface text-foreground p-3 rounded text-sm overflow-x-auto">
                      {`<input
  type={showPassword ? 'text' : 'password'}
...
>
  {/* Eye icon */}
            ...
            <div className="bg-surface-raised p-6 rounded">
              ...
              <div className="space-y-6 text-foreground">
                ...
                <div>
                  <h4 className="text-l text-foreground-emp mb-2">
                    1. The <code className="text-primary">input</code> Utility
                  </h4>
                  <p className="text-l text-foreground-de-emp mb-2">
  ...
  &:focus {
    ...
    border-width: 2px;
                ...
                {/* Validation States */}
                <div>
                  <h4 className="text-l text-foreground-emp mb-2">2. Validation State Utilities</h4>
                  <p className="text-l text-foreground-de-emp mb-3">
                    <code className="text-primary">input-success</code> and{' '}
                    <code className="text-primary">input-error</code>
  ...
  border-color: var(--color-success-icon);
                      ...
                      <div className="text-foreground-de-emp mt-2">
                        Token: <code>--color-success-icon</code> → Semantic color that adapts to
                        theme
                      </div>
                    </div>
  ...
  border-color: var(--color-error-icon);
                ...
                <div>
                  <h4 className="text-l text-foreground-emp mb-2">3. Working with JavaScript</h4>
                  <p className="text-l text-foreground-de-emp mb-3">
                    Apollo Wind utilities work seamlessly with dynamic class names:
                  </p>

                  <div className="bg-surface text-foreground p-4 rounded text-sm">
                    <div className="text-primary font-semibold mb-2">Email Validation Example:</div>
                    <pre className="bg-surface-raised text-foreground p-3 rounded overflow-x-auto">
...
/>`}
                  ...
                  <div className="bg-surface text-foreground p-4 rounded text-xs mt-3">
...
>
  Toggle
                ...
                <div className="bg-info p-4 rounded border-l-4 border-info-600">
                  ...
                  <p className="text-l text-foreground-de-emp">
                    Apollo Wind utilities are designed to work with JavaScript frameworks. Base
                    styles (<code className="text-primary">input</code>) + state modifiers (
...
export const Story6_AnimationsAndStatus: Story = {
            ...
            <div>
              ...
              <div className="card card-elevated p-6">
                ...
                >
                  {isLoading && (
                    <svg
                      className="icon-sm mr-2 animate-spin"
                      viewBox="0 0 24 24"
                      fill="none"
                      stroke="currentColor"
                    >
                ...
                {showSuccess && (
                  <div className="bg-success border-l-4 border-success-600 p-4 mt-4 rounded">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-l text-foreground-emp font-semibold">Success!</p>
                        <p className="text-l text-foreground-de-emp">
              ...
              <div className="mt-6 bg-surface-raised p-4 rounded">
                ...
                <div className="space-y-3">
                  <div>
                    <p className="text-m text-foreground-de-emp mb-1">Loading Spinner:</p>
                    <pre className="bg-surface text-foreground p-3 rounded text-sm overflow-x-auto">
  ...
  <span>Loading...</span>
                  ...
                  <div>
                    <p className="text-m text-foreground-de-emp mb-1">Status Alerts:</p>
                    <pre className="bg-surface text-foreground p-3 rounded text-sm overflow-x-auto">
                      {`<div class="bg-success p-4 rounded">
  <span class="text-success">Success!</span>
</div>

<div class="bg-error p-4 rounded">
  <span class="text-error">Error occurred</span>
              ...
              <div className="space-y-4 mt-4">
                <h4 className="text-l text-foreground-emp mb-3">Status Message Examples</h4>
                <div className="bg-success border-l-4 border-success-600 p-4 rounded">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-l text-foreground-emp">Success message</span>
                  </div>
                </div>
                ...
                <div className="bg-error border-l-4 border-error-600 p-4 rounded">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-l text-foreground-emp">Error message</span>
                  </div>
                </div>
                ...
                <div className="bg-warning border-l-4 border-warning-600 p-4 rounded">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-l text-foreground-emp">Warning message</span>
                  </div>
                </div>
                ...
                <div className="bg-info border-l-4 border-info-600 p-4 rounded">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-l text-foreground-emp">Info message</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-surface-raised p-6 rounded">
              ...
              <div className="space-y-6 text-foreground">
                ...
                <div>
                  <h4 className="text-l text-foreground-emp mb-2">
                    1. <code className="text-primary">animate-spin</code>
                  </h4>
                  <p className="text-l text-foreground-de-emp mb-3">
  ...
  animation: spin 1s linear infinite;
                    ...
                    <div className="pt-3 border-t border-border">
                      <p className="text-foreground-de-emp">
                        <strong>Key Point:</strong> Tailwind's{' '}
                        <code className="text-primary">animate-spin</code> utility works out of the
                        box because Apollo Wind provides the <code>spin</code> keyframes definition!
                      </p>
                    </div>
                  </div>
                </div>
                ...
                {/* Other Animations */}
                <div>
                  <h4 className="text-l text-foreground-emp mb-2">2. Other Animations Supported</h4>
                  <p className="text-l text-foreground-de-emp mb-2">
                    Apollo Wind provides several @keyframes animations:
                  </p>
                  <div className="bg-surface text-foreground p-3 rounded text-xs space-y-2">
                ...
                {/* Status Colors */}
                <div>
                  <h4 className="text-l text-foreground-emp mb-2">3. Status Color Utilities</h4>
                  <p className="text-l text-foreground-de-emp mb-3">
                  ...
                  <div className="bg-surface text-foreground p-4 rounded space-y-3 text-sm">
                    ...
                    <div>
                      ...
                      <p className="text-foreground-de-emp">
                        ...
                        <br />
                        <code className="text-primary">bg-error</code>,{' '}
                        <code className="text-primary">text-error</code>,{' '}
                        <code className="text-primary">border-error-600</code>
                        <br />
                        <code className="text-primary">bg-warning</code>,{' '}
                        <code className="text-primary">text-warning</code>,{' '}
                        <code className="text-primary">border-warning-600</code>
                        <br />
                        <code className="text-primary">bg-info</code>,{' '}
                        <code className="text-primary">text-info</code>,{' '}
                        <code className="text-primary">border-info-600</code>
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-success p-4 rounded border-l-4 border-success-600">
                  ...
                  <p className="text-l text-foreground-de-emp">
                    ...
                    border accents (<code className="text-primary">border-l-4</code>) and proper
                    spacing for accessible, theme-aware feedback messages.
                  </p>
                </div>
              </div>
            </div>
