...
const CARDS = [
  {
    title: 'Apollo Design',
    description:
      "UiPath's open-source design system — Wind components and Canvas (apollo-react) for building consistent user experiences across all UiPath products.",
    url: 'https://apollo-design.vercel.app/',
