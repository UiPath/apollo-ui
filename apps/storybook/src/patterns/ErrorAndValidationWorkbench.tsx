...
import { createNode, useCanvasStory } from '@uipath/apollo-react/canvas/storybook-utils';
...
export function ErrorAndValidationWorkbench({
  renderRightPanel,
  takeoverOverlay,
}: {
  renderRightPanel?: (props: { onClose: () => void }) => ReactNode;
  /** Rendered inside the canvas-scoped positioned container so a `CanvasTakeoverModal` can fill it. */
  takeoverOverlay?: ReactNode;
} = {}) {
