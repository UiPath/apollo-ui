...
export function MaterialRadio() {
	...
	return (
		<PageContainer>
			...
			<PageDescription>
				Material UI Radio component with Apollo theme overrides. Features custom
				colors, focus states, and selection indicators.
			</PageDescription>

			<VariantSection>
				<SectionHeader>Basic Radios</SectionHeader>
				<SectionDescription>
					Standard radio buttons with Apollo theme styling.
				</SectionDescription>
				<RadioGrid>
			...
			<VariantSection>
				...
				<SectionDescription>
					Radio buttons with different color props.
				</SectionDescription>
				<RadioGrid>
			...
			<VariantSection>
				...
				<SectionDescription>
					Radio buttons in different sizes (small, medium).
				</SectionDescription>
				<RadioGrid>
