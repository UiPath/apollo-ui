...
export function MaterialCheckbox() {
	...
	return (
		<PageContainer>
			...
			<PageDescription>
				Material UI Checkbox component with Apollo theme overrides. Features
				custom colors, focus states, and check icon styling.
			</PageDescription>

			<VariantSection>
				<SectionHeader>Basic Checkboxes</SectionHeader>
				<SectionDescription>
					Standard checkboxes with Apollo theme styling.
				</SectionDescription>
				<CheckboxGrid>
			...
			<VariantSection>
				...
				<SectionDescription>
					Checkbox with controlled state management.
				</SectionDescription>
				<CheckboxGrid>
					<Checkbox
						checked={checked}
			...
			<VariantSection>
				...
				<SectionDescription>
					Checkboxes with different color props.
				</SectionDescription>
				<CheckboxGrid>
			...
			<VariantSection>
				...
				<SectionDescription>
					Checkboxes in different sizes (small, medium).
				</SectionDescription>
				<CheckboxGrid>
