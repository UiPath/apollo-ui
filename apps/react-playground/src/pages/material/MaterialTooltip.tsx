...
export function MaterialTooltip() {
	return (
		<PageContainer>
			...
			<PageDescription>
				Material UI Tooltip component with Apollo theme overrides. Features
				custom styling, placement options, and interactive behaviors.
			</PageDescription>

			<VariantSection>
				<SectionHeader>Basic Tooltip</SectionHeader>
				<SectionDescription>
					Standard tooltip with Apollo theme styling.
				</SectionDescription>
				<TooltipGrid>
			...
			<VariantSection>
				...
				<SectionDescription>
					Tooltips with an arrow pointing to the element.
				</SectionDescription>
				<TooltipGrid>
			...
			<VariantSection>
				...
				<SectionDescription>
					Tooltips with longer descriptive text content.
				</SectionDescription>
				<TooltipGrid>
					<Tooltip
			...
			<VariantSection>
				...
				<SectionDescription>
					Tooltip on a disabled element (wrapped in span).
				</SectionDescription>
				<TooltipGrid>
