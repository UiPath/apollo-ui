...
export function MaterialSlider() {
  ...
  return (
    <PageContainer>
      ...
      <PageDescription>
        Material UI Slider component with Apollo theme overrides. Features custom track styling,
        thumb indicators, and value labels.
      </PageDescription>

      <VariantSection>
        <SectionHeader>Basic Slider</SectionHeader>
        <SectionDescription>Standard slider with Apollo theme styling.</SectionDescription>
        <SliderContainer>
      ...
      <VariantSection>
        ...
        <SectionDescription>Slider with controlled state management.</SectionDescription>
        <SliderContainer>
      ...
      <VariantSection>
        ...
        <SectionDescription>Slider displaying value label on thumb.</SectionDescription>
        <SliderContainer>
      ...
      <VariantSection>
        ...
        <SectionDescription>Slider with discrete steps and marks.</SectionDescription>
        <SliderContainer>
      ...
      <VariantSection>
        ...
        <SectionDescription>Slider with custom labeled marks.</SectionDescription>
        <SliderContainer>
          <Slider
            defaultValue={20}
            step={null}
      ...
      <VariantSection>
        ...
        <SectionDescription>Slider with two thumbs for selecting a range.</SectionDescription>
        <SliderContainer>
          <Slider
            value={rangeValue}
      ...
      <VariantSection>
        ...
        <SectionDescription>Sliders with different color props.</SectionDescription>
        <SliderContainer>
      ...
      <VariantSection>
        ...
        <SectionDescription>Sliders in different sizes (small, medium).</SectionDescription>
        <SliderContainer>
