  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <PageContainer>
        ...
        <PageDescription>
          Material UI DatePicker component with Apollo theme overrides. Provides an accessible date
          selection interface with calendar popover.
        </PageDescription>

        <VariantSection>
          <SectionHeader>Basic DatePicker</SectionHeader>
          <SectionDescription>Standard date picker with Apollo theme styling.</SectionDescription>
          <FormGrid>
            <DatePicker
              label="Select Date"
              value={basicDate}
        ...
        <VariantSection>
          ...
          <SectionDescription>DatePicker marked as required with asterisk.</SectionDescription>
          <FormGrid>
            <DatePicker
              label="Required Date"
              value={requiredDate}
        ...
        <VariantSection>
          ...
          <SectionDescription>DatePicker in read-only mode (cannot be changed).</SectionDescription>
          <FormGrid>
            <DatePicker
        ...
        <VariantSection>
          ...
          <SectionDescription>DatePicker in disabled state with muted styling.</SectionDescription>
          <FormGrid>
            <DatePicker
              label="Disabled Date"
              value={disabledDate}
