...
import {
	ProgressContainer,
	VariantSection,
} from "./MaterialLinearProgress.styles";
...
export function MaterialLinearProgress() {
	return (
		<PageContainer>
			...
			<PageDescription>
				Material UI LinearProgress component with Apollo theme overrides.
			...
			<VariantSection>
				...
				<SectionDescription>
					Standard linear progress bar (indeterminate).
				</SectionDescription>
				<ProgressContainer>
					<LinearProgress />
				</ProgressContainer>
			...
			<VariantSection>
				...
				<SectionDescription>
					Linear progress with different color props.
				</SectionDescription>
				<ProgressContainer>
			...
			<VariantSection>
				...
				<SectionDescription>
					Linear progress with specific values (determinate).
				</SectionDescription>
				<ProgressContainer>
