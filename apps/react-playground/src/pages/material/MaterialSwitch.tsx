...
export function MaterialSwitch() {
	...
	return (
		<PageContainer>
			...
			<PageDescription>
				Material UI Switch component with Apollo theme overrides. Features
				custom colors, focus states, and toggle animations.
			</PageDescription>

			<VariantSection>
				<SectionHeader>Basic Switches</SectionHeader>
				<SectionDescription>
					Standard toggle switches with Apollo theme styling.
				</SectionDescription>
				<SwitchGrid>
