...
export function MaterialButtons() {
  return (
    <PageContainer>
      ...
      <PageDescription>
        Material UI Button, IconButton, and Fab components with Apollo theme overrides. Includes
        customized colors, hover states, focus indicators, and sizing variants.
      </PageDescription>

      <section style={{ marginBottom: '48px' }}>
        <SectionHeader>Standard Buttons</SectionHeader>
        <SectionDescription>
          Primary action buttons with three variants: contained (solid), outlined (border), and text
          (minimal).
        </SectionDescription>
        <div
          style={{
      ...
      <section>
        ...
        <SectionDescription>
          Special warning variant using custom Apollo styling for destructive actions.
        </SectionDescription>
        <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
