...
export function MaterialMenuItem() {
  ...
  return (
    <PageContainer>
      ...
      <PageDescription>
        Material UI MenuItem component with Apollo theme overrides. Used within Menu components to
        display selectable options with custom styling.
      </PageDescription>

      <VariantSection>
        <SectionHeader>Basic Menu Items</SectionHeader>
        <SectionDescription>Standard menu with Apollo themed menu items.</SectionDescription>
        <MenuContainer>
      ...
      <VariantSection>
        ...
        <SectionDescription>
          MenuItem components demonstrate hover, focus, and disabled states with Apollo theme
          styling including custom background colors, text colors, and interactive feedback.
        </SectionDescription>
      </VariantSection>
    </PageContainer>
  );
