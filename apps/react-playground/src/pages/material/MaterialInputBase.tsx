...
export function MaterialInputBase() {
	return (
		<PageContainer>
			...
			<PageDescription>
				Material UI InputBase component with Apollo theme overrides. A
			...
			<VariantSection>
				...
				<SectionDescription>
					Unstyled input component demonstrating the minimal primitive nature of
					InputBase.
				</SectionDescription>
				<FormGrid>
			...
			<VariantSection>
				...
				<SectionDescription>
					InputBase with start and end adornments.
				</SectionDescription>
				<FormGrid>
					<InputBase
						placeholder="Search..."
			...
			<VariantSection>
				...
				<SectionDescription>
					InputBase with multiline support (textarea).
				</SectionDescription>
				<FormGrid>
					<InputBase
