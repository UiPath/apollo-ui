...
export function MaterialInputs() {
	...
	return (
		<PageContainer>
			...
			<PageDescription>
				Material UI input components (InputLabel, InputAdornment, OutlinedInput)
				with Apollo theme overrides. These components work together to create
			...
			<section style={{ marginBottom: "48px" }}>
				...
				<SectionDescription>
					Standard outlined inputs with labels using OutlinedInput and
					InputLabel.
				</SectionDescription>
			...
			<section style={{ marginBottom: "48px" }}>
				...
				<SectionDescription>
					Input fields with icons or text positioned at the start or end using
					InputAdornment.
				</SectionDescription>
				<div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
					<TextField
			...
			<section style={{ marginBottom: "48px" }}>
				...
				<SectionDescription>
					Alternative input variant with bottom border only.
				</SectionDescription>
			...
			<section style={{ marginBottom: "48px" }}>
				...
				<SectionDescription>
					InputLabel providing context for Select components.
				</SectionDescription>
				<FormControl variant="outlined" sx={{ minWidth: 300 }}>
			...
			<section style={{ marginBottom: "48px" }}>
				...
				<SectionDescription>
					Input fields in different sizes (small and medium).
				</SectionDescription>
				<div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
			...
			<section style={{ marginBottom: "48px" }}>
				...
				<SectionDescription>
					Input fields with required indicator (asterisk).
				</SectionDescription>
			...
			<section style={{ marginBottom: "48px" }}>
				...
				<SectionDescription>
					Input fields in error state with error messages.
				</SectionDescription>
				<div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
			...
			<section>
				...
				<SectionDescription>
					Input fields in disabled state with muted styling.
				</SectionDescription>
