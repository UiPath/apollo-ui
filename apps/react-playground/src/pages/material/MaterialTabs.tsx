...
export function MaterialTabs() {
	...
	return (
		<PageContainer>
			...
			<PageDescription>
				Material UI Tabs and Tab components with Apollo theme overrides.
				Features custom tab styling, indicators, and navigation patterns.
			</PageDescription>

			<section style={{ marginBottom: "48px" }}>
				<SectionHeader>Basic Tabs</SectionHeader>
				<SectionDescription>
					Simple tabs with text labels and content switching.
				</SectionDescription>
				<Box sx={{ borderBottom: 1, borderColor: "divider" }}>
					<Tabs
						value={basicTabValue}
						onChange={(_, newValue) => setBasicTabValue(newValue)}
					>
						<Tab label="Tab One" />
						<Tab label="Tab Two" />
						<Tab label="Tab Three" />
			...
			<section style={{ marginBottom: "48px" }}>
				...
				<SectionDescription>
					Tabs displaying both icons and text labels.
				</SectionDescription>
				<Box sx={{ borderBottom: 1, borderColor: "divider" }}>
					<Tabs
						value={iconTabValue}
						onChange={(_, newValue) => setIconTabValue(newValue)}
					>
			...
			<section style={{ marginBottom: "48px" }}>
				...
				<SectionDescription>
					Tabs with only icon elements (no text labels).
				</SectionDescription>
				<Box sx={{ borderBottom: 1, borderColor: "divider" }}>
					<Tabs
						value={iconOnlyTabValue}
						onChange={(_, newValue) => setIconOnlyTabValue(newValue)}
					>
			...
			<section style={{ marginBottom: "48px" }}>
				...
				<Box sx={{ borderBottom: 1, borderColor: "divider" }}>
					<Tabs
						value={badgeTabValue}
						onChange={(_, newValue) => setBadgeTabValue(newValue)}
					>
						<Tab
							label={
			...
			<section style={{ marginBottom: "48px" }}>
				...
				<SectionDescription>
					Tabs with some items in disabled state.
				</SectionDescription>
				<Box sx={{ borderBottom: 1, borderColor: "divider" }}>
					<Tabs
						value={disabledTabValue}
						onChange={(_, newValue) => setDisabledTabValue(newValue)}
					>
						<Tab label="Active" />
			...
			<section style={{ marginBottom: "48px" }}>
				...
				<SectionDescription>
					Tabs centered in their container.
				</SectionDescription>
				<Box sx={{ borderBottom: 1, borderColor: "divider" }}>
					<Tabs
