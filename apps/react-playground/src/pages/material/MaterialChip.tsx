...
export function MaterialChip() {
	return (
		<PageContainer>
			...
			<PageDescription>
				Material UI Chip component with Apollo theme overrides. Features custom
				colors, icons, and interactive states.
			</PageDescription>

			<VariantSection>
				<SectionHeader>Basic Chips</SectionHeader>
				<SectionDescription>
					Standard chips with Apollo theme styling.
				</SectionDescription>
				<ChipGrid>
					<Chip label="Default" />
			...
			<VariantSection>
				...
				<SectionDescription>
					Chips with different color props.
				</SectionDescription>
				<ChipGrid>
			...
			<VariantSection>
				...
				<SectionDescription>
					Chips in different sizes (small, medium).
				</SectionDescription>
				<ChipGrid>
			...
			<VariantSection>
				...
				<SectionDescription>
					Chips that are both clickable and deletable.
				</SectionDescription>
				<ChipGrid>
					<Chip
						label="React"
