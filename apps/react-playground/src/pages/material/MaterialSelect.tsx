...
export function MaterialSelect() {
  ...
  return (
    <PageContainer>
      ...
      <PageDescription>
        Material UI Select component with Apollo theme overrides. Features custom dropdown styling,
        menu items, and focus states.
      </PageDescription>

      <VariantSection>
        <SectionHeader>Basic Select</SectionHeader>
        <SectionDescription>Standard select dropdown with Apollo theme styling.</SectionDescription>
        <SelectGrid>
      ...
      <VariantSection>
        ...
        <SectionDescription>Select component allowing multiple selections.</SectionDescription>
      ...
      <VariantSection>
        ...
        <SectionDescription>Select component in disabled state.</SectionDescription>
