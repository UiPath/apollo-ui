...
export function MaterialTextField() {
  ...
  return (
    <PageContainer>
      ...
      <PageDescription>
        Material UI TextField component with Apollo theme overrides. Includes customized borders,
        focus states, labels, and helper text styling.
      </PageDescription>
      ...
      <VariantSection>
        ...
        <SectionDescription>Standard text fields with bottom border only.</SectionDescription>
        <TextFieldGrid>
      ...
      <VariantSection>
        ...
        <SectionDescription>Text fields in different sizes (small and medium).</SectionDescription>
        <TextFieldGrid>
