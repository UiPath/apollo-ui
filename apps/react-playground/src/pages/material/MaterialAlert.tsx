...
export function MaterialAlert() {
  return (
    <PageContainer>
      ...
      <PageDescription>
        Material UI Alert component with Apollo theme overrides. Features custom severity colors,
        icons, and close button styling.
      </PageDescription>
      ...
      <VariantSection>
        ...
        <SectionDescription>Alerts with filled style for higher emphasis.</SectionDescription>
        <AlertStack>
      ...
      <VariantSection>
        ...
        <SectionDescription>Alerts with a close button for dismissal.</SectionDescription>
        <AlertStack>
          <Alert severity="info" onClose={() => alert('Alert closed!')}>
            This alert can be closed
          </Alert>
          <Alert variant="outlined" severity="warning" onClose={() => alert('Alert closed!')}>
