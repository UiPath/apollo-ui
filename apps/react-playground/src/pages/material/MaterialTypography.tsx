...
export function MaterialTypography() {
	return (
		<PageContainer>
			...
			<PageDescription>
				Material UI Typography component with Apollo theme overrides. Features
				custom font families, sizes, weights, and text styles.
			</PageDescription>

			<VariantSection>
				<SectionHeader>Heading Variants</SectionHeader>
				<SectionDescription>
					Typography variants for headings (h1 through h6).
				</SectionDescription>
				<TypographyStack>
			...
			<VariantSection>
				...
				<SectionDescription>
					Typography with different color props.
				</SectionDescription>
				<TypographyStack>
			...
			<VariantSection>
				...
				<TypographyStack>
					...
					<Typography noWrap sx={{ maxWidth: 300 }}>
						Text that will not wrap and will be truncated with ellipsis when
						it's too long for the container
					</Typography>
				</TypographyStack>
			</VariantSection>
		</PageContainer>
