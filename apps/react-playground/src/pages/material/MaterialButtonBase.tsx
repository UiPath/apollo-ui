...
export function MaterialButtonBase() {
	return (
		<PageContainer>
			...
			<PageDescription>
				Material UI ButtonBase component with Apollo theme overrides. A
				low-level button primitive that provides hover, focus, and ripple
				effects. Used as the foundation for other button components.
			</PageDescription>
			...
			<VariantSection>
				...
				<ButtonGrid>
					<ButtonBase sx={{ padding: "8px 16px", borderRadius: "4px" }}>
						Click Me
					</ButtonBase>
					<ButtonBase sx={{ padding: "8px 16px", borderRadius: "4px" }}>
						Another Button
			...
			<VariantSection>
				...
				<SectionDescription>
					ButtonBase with custom styling applied.
				</SectionDescription>
				<ButtonGrid>
					<ButtonBase
						sx={{
			...
			<VariantSection>
				...
				<SectionDescription>
					ButtonBase containing icon elements.
				</SectionDescription>
				<ButtonGrid>
					<ButtonBase
						sx={{
			...
			<VariantSection>
				...
				<SectionDescription>
					ButtonBase used as icon buttons.
				</SectionDescription>
				<ButtonGrid>
					<ButtonBase
						sx={{
			...
			<VariantSection>
				...
				<SectionDescription>
					ButtonBase in disabled state without interactions.
				</SectionDescription>
				<ButtonGrid>
					<ButtonBase
						disabled
			...
			<VariantSection>
				...
				<SectionDescription>
					ButtonBase with customized ripple effects.
				</SectionDescription>
				<ButtonGrid>
					<ButtonBase
			...
			<VariantSection>
				...
				<SectionDescription>
					ButtonBase used to create clickable cards.
				</SectionDescription>
				<ButtonGrid>
					<ButtonBase
						sx={{
