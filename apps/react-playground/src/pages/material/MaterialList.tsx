...
export function MaterialList() {
  ...
  return (
    <PageContainer>
      ...
      <PageDescription>
        Material UI List components with Apollo theme overrides. Displays lists of items with
        various configurations and interactive states.
      </PageDescription>
      ...
      <section style={{ marginBottom: '48px' }}>
        ...
        <SectionDescription>List items with leading icons for visual clarity.</SectionDescription>
        <List
          sx={{
            maxWidth: 500,
            border: '1px solid var(--color-border)',
      ...
      <section style={{ marginBottom: '48px' }}>
        ...
        <SectionDescription>List items separated by dividers.</SectionDescription>
        <List
          sx={{
            maxWidth: 500,
            border: '1px solid var(--color-border)',
      ...
      <section style={{ marginBottom: '48px' }}>
        ...
        <SectionDescription>Compact list with reduced spacing.</SectionDescription>
        <List
          dense
          sx={{
            maxWidth: 500,
      ...
      <section>
        ...
        <SectionDescription>List with disabled interactive items.</SectionDescription>
        <List
          sx={{
            maxWidth: 500,
            border: '1px solid var(--color-border)',
