...
export function MainHome() {
  const sections = [
    {
      title: 'Core',
      description: 'Design tokens, colors, typography, spacing, and foundational elements',
      path: '/core',
      icon: '🎨',
      status: 'available',
    },
    ...
    },
    {
      ...
      description: 'Material UI component theme overrides with Apollo design system',
      path: '/material',
      icon: '🎭',
      status: 'available',
    },
  ...
  return (
    <MainContainer>
      <Header>
        ...
        <MainDescription>Explore our design tokens and component library</MainDescription>
      </Header>
            ...
            <SectionCard
              ...
              onMouseEnter={(e) => {
                if (section.status === 'available') {
                  ...
                  e.currentTarget.style.boxShadow = 'var(--shadow-hover-primary)';
