...
export function ComponentsHome() {
  ...
  return (
    <PageContainer>
      ...
      <Subtitle>Full-featured React components built with the Apollo Design System</Subtitle>
      <Description>
        These are complete, production-ready components that leverage Apollo design tokens and
        provide rich functionality out of the box. Each component is fully customizable and
      ...
      <FeaturesGrid>
        <FeatureCard>
          ...
          <p>Built from the ground up using Apollo core tokens for consistent styling</p>
        </FeatureCard>
        <FeatureCard>
          <ComponentIcon>🌓</ComponentIcon>
        ...
        <FeatureCard>
          ...
          <p>Extensive configuration options to adapt components to your needs</p>
        </FeatureCard>
      </FeaturesGrid>
