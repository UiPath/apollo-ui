	...
	return (
		<PageContainer>
			<CenterContainer>
				...
				<Subtitle>
					Explore the complete design token library from
					@uipath/apollo-react/core
				</Subtitle>
				<InfoBox>
					<InfoItem>
						<strong>CSS Import:</strong>{" "}
						<InlineCode>
							@uipath/apollo-react/core/tokens/css/variables.css
						</InlineCode>
					</InfoItem>
					<InfoItem>
						<strong>JS Import:</strong>{" "}
						<InlineCode>@uipath/apollo-react/core</InlineCode>
					</InfoItem>
				</InfoBox>
			</CenterContainer>
