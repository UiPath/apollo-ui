...
export function MaterialHome() {
  ...
  return (
    <PageContainer>
      ...
      <Subtitle>Apollo Design System theme customizations for Material UI components</Subtitle>
      <Description>
        These overrides apply Apollo design tokens to Material UI components, ensuring consistent
        styling across your application. Each component showcases the themed variants with
      ...
      <FeaturesGrid>
        <FeatureCard>
          ...
          <p>All overrides use Apollo core tokens for colors, spacing, typography, and more</p>
        </FeatureCard>
        <FeatureCard>
          <ComponentIcon>🌓</ComponentIcon>
          <FeatureTitle>Dark Mode Support</FeatureTitle>
          <p>Seamless light and dark theme support with automatic color adaptation</p>
        </FeatureCard>
        <FeatureCard>
          <ComponentIcon>♿</ComponentIcon>
          <FeatureTitle>Accessibility First</FeatureTitle>
          <p>Enhanced focus indicators and WCAG compliant contrast ratios throughout</p>
        </FeatureCard>
      </FeaturesGrid>
