...
export function TreeViewShowcase() {
  ...
  return (
    <PageContainer>
      ...
      <PageDescription>Hierarchical data display component for nested structures</PageDescription>

      <ShowcaseSection>
        <SectionTitle>Interactive Selection with Chevron</SectionTitle>
        <ComponentRow>
          <Label>File browser with selection tracking and chevron indicator</Label>
          <ApTreeView
      ...
      <ShowcaseSection>
        ...
        <ComponentRow>
          <Label>Tree with icons, colors, descriptions (tooltips), and additional info</Label>
          <ApTreeView
      ...
      <ShowcaseSection>
        ...
        <ComponentRow>
          <Label>Only &quot;src&quot; and &quot;components&quot; folders expanded</Label>
