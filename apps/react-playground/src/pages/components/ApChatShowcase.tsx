...
export function ApChatShowcase() {
  ...
  const [chatMode, setChatMode] = useState<AutopilotChatMode>(AutopilotChatMode.SideBySide);
  ...
  }, [features, chatService, selectedModel, selectedAgentMode, createSettingsRenderer, chatMode]);
...
\`\`\``;
  ...
  return (
    <ShowcaseContainer>
      ...
      >
        <h2 style={{ margin: '0 0 24px 0', color: 'var(--color-primary)' }}>ApChat Showcase</h2>
        ...
        <Section>
          ...
          <ButtonGroup>
            <Button onClick={setAllowedAttachments}>Set Allowed Attachments</Button>
            <Button onClick={setPreHook}>Set Pre Hook</Button>
          </ButtonGroup>
          <ButtonGroup>
            <Button onClick={setFirstRunExperience}>Set First Run Experience</Button>
          </ButtonGroup>
        </Section>
        ...
        <Section>
          ...
          <ButtonGroup>
            <Button onClick={setCustomHeaderActions}>Set Custom Header Actions</Button>
            <Button onClick={clearCustomHeaderActions}>Clear Custom Header Actions</Button>
          </ButtonGroup>
        </Section>
        ...
        <Section>
          ...
          <Select value={selectedAgentMode} onChange={(e) => handleAgentModeChange(e.target.value)}>
        ...
        <Section>
          ...
          <ButtonGroup>
            ...
            <Button onClick={sendResponseDisabledActions}>Disabled Actions</Button>
          </ButtonGroup>
          <ButtonGroup>
      ...
      {chatService && (
        <ChatContainer>
          <ApChat chatServiceInstance={chatService} locale={locale} theme={chatTheme} />
        </ChatContainer>
      )}
