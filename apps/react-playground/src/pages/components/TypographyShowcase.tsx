...
export function TypographyShowcase() {
	...
	return (
		<PageContainer>
			...
			<PageDescription>
				Typography component variants using Apollo design tokens
			</PageDescription>
				...
				<ComponentRow>
					<VariantItem>
						<VariantLabel>
							...
							<VariantProps>
								{getTypographyProps("fontSizeHeroBold")}
							</VariantProps>
						</VariantLabel>
				...
				<ComponentRow>
					<VariantItem>
						<VariantLabel>
							...
							<VariantProps>
								{getTypographyProps("fontSizeH1Bold")}
							</VariantProps>
						</VariantLabel>
					...
					<VariantItem>
						<VariantLabel>
							...
							<VariantProps>
								{getTypographyProps("fontSizeH2Bold")}
							</VariantProps>
						</VariantLabel>
					...
					<VariantItem>
						<VariantLabel>
							...
							<VariantProps>
								{getTypographyProps("fontSizeH3Bold")}
							</VariantProps>
						</VariantLabel>
					...
					<VariantItem>
						<VariantLabel>
							...
							<VariantProps>
								{getTypographyProps("fontSizeH4Bold")}
							</VariantProps>
						</VariantLabel>
				...
				<ComponentRow>
					...
					<VariantItem>
						<VariantLabel>
							...
							<VariantProps>
								{getTypographyProps("fontSizeXsBold")}
							</VariantProps>
						</VariantLabel>
			...
			<ShowcaseSection>
				...
				<ComponentRow>
					<VariantItem>
						...
						<ApTypography
							variant={FontVariantToken.fontBrandH4}
							color="var(--color-primary)"
						>
							The quick brown fox jumps over the lazy dog
						</ApTypography>
					...
					<VariantItem>
						...
						<ApTypography
							variant={FontVariantToken.fontBrandM}
							color="var(--color-primary)"
						>
							The quick brown fox jumps over the lazy dog
						</ApTypography>
				...
				<ComponentRow>
					...
					<VariantItem>
						<VariantLabel>
							...
							<VariantProps>
								{getTypographyProps("fontMonoXSBold")}
							</VariantProps>
						</VariantLabel>
