        ...
        <AppContainer>
          ...
          <MainContent>
            ...
            <Routes>
              ...
              <Route path="/material/autocomplete" element={<MaterialAutocomplete />} />
              <Route path="/material/button-base" element={<MaterialButtonBase />} />
              ...
              <Route path="/material/circular-progress" element={<MaterialCircularProgress />} />
              <Route path="/material/datepicker" element={<MaterialDatepicker />} />
              <Route path="/material/dialog" element={<MaterialDialog />} />
              <Route path="/material/divider" element={<MaterialDivider />} />
              <Route path="/material/form-controls" element={<MaterialFormControls />} />
              <Route path="/material/input-base" element={<MaterialInputBase />} />
              <Route path="/material/inputs" element={<MaterialInputs />} />
              <Route path="/material/linear-progress" element={<MaterialLinearProgress />} />
              <Route path="/material/link" element={<MaterialLink />} />
              <Route path="/material/list" element={<MaterialList />} />
              <Route path="/material/menu-item" element={<MaterialMenuItem />} />
              ...
              <Route path="/material/text-field" element={<MaterialTextField />} />
              <Route path="/material/tooltip" element={<MaterialTooltip />} />
              <Route path="/material/typography" element={<MaterialTypography />} />
              <Route path="/components" element={<ComponentsHome />} />
              <Route path="/components/alert-bar" element={<AlertBarShowcase />} />
              ...
              <Route path="/components/skeleton" element={<SkeletonShowcase />} />
              <Route path="/components/text-area" element={<TextAreaShowcase />} />
              <Route path="/components/text-field" element={<TextFieldShowcase />} />
              <Route path="/components/tool-call" element={<ToolCallShowcase />} />
              <Route path="/components/tree-view" element={<TreeViewShowcase />} />
              <Route path="/components/typography" element={<TypographyShowcase />} />
            </Routes>
          </MainContent>
        </AppContainer>
      </BrowserRouter>
