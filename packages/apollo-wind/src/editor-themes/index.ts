/**
 * Apollo Future editor theme adapters.
 *
 ...
 * ```
 */
export { apolloFutureDarkMonaco, apolloFutureLightMonaco } from './monaco';
export type {
  ApolloFutureCodeMirrorTheme,
  CodeMirrorSyntaxTokens,
  CodeMirrorUiTokens,
} from './codemirror';
export { apolloFutureDarkCodeMirror, apolloFutureLightCodeMirror } from './codemirror';
