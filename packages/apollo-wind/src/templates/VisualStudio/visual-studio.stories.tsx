...
export const Default: Story = {
  name: 'Default',
  render: (_, { globals }) => <VSCodeShellDemo theme={globals.theme || 'dark'} />,
};

export const Minimal: Story = {
  name: 'Minimal',
  render: (_, { globals }) => <MinimalShellDemo theme={globals.theme || 'dark'} />,
};

export const SidebarOnly: Story = {
  name: 'Sidebar Only',
  render: (_, { globals }) => <SidebarOnlyDemo theme={globals.theme || 'dark'} />,
};
