...
import {
  ...
  ViewportGuard,
} from '@/components/ui/viewport-guard';
import { DelegatePanel } from '@/components/custom/panel-delegate';
import { Canvas } from '@/components/custom/canvas';
import type { NavItem, NavChildItem, DelegatePanelProps } from '@/components/custom/panel-delegate';
...
export function DelegateTemplate({
  ...
  return (
    <ViewportGuard minWidth={769} message="This view is not available at this screen size. Please use a larger viewport.">
      {layout}
    </ViewportGuard>
  );
}
