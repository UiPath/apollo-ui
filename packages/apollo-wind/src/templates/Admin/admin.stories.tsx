...
const users: UserRow[] = [
  ...
  { id: '2', name: 'John Doe', email: 'john.doe@example.com', role: 'Tenant Administrator', type: 'user' },
  { id: '3', name: 'Engineering', email: '', role: 'Automation Developer', type: 'group' },
  { id: '4', name: 'Jane Smith', email: 'jane.smith@example.com', role: 'Tenant Administrator', type: 'user' },
  { id: '5', name: 'QA Team', email: '', role: 'Test-role-viewer', type: 'group' },
  { id: '6', name: 'Carlos Rivera', email: 'carlos.rivera@example.com', role: 'Automation Developer', type: 'user' },
  { id: '7', name: 'DevOps', email: '', role: 'Tenant Administrator', type: 'group' },
  { id: '8', name: 'Aisha Patel', email: 'aisha.patel@example.com', role: 'Automation User', type: 'user' },
  { id: '9', name: 'Marketing', email: '', role: 'Viewer', type: 'group' },
  { id: '10', name: 'Liam Chen', email: 'liam.chen@example.com', role: 'Automation Developer', type: 'user' },
  { id: '11', name: 'Support Tier-1', email: '', role: 'Viewer', type: 'group' },
  { id: '12', name: 'Sofia Müller', email: 'sofia.muller@example.com', role: 'Tenant Administrator', type: 'user' },
  { id: '13', name: 'Data Science', email: '', role: 'Automation Developer', type: 'group' },
  { id: '14', name: 'Raj Kapoor', email: 'raj.kapoor@example.com', role: 'Automation User', type: 'user' },
  { id: '15', name: 'HR Operations', email: '', role: 'Viewer', type: 'group' },
  { id: '16', name: 'Emily Watson', email: 'emily.watson@example.com', role: 'Tenant Administrator', type: 'user' },
  { id: '17', name: 'Platform Team', email: '', role: 'Automation Developer', type: 'group' },
  { id: '18', name: 'Tomás García', email: 'tomas.garcia@example.com', role: 'Automation User', type: 'user' },
  { id: '19', name: 'Security', email: '', role: 'Tenant Administrator', type: 'group' },
  { id: '20', name: 'Yuki Tanaka', email: 'yuki.tanaka@example.com', role: 'Automation Developer', type: 'user' },
  { id: '21', name: 'Sales Ops', email: '', role: 'Viewer', type: 'group' },
  { id: '22', name: 'Alex Novak', email: 'alex.novak@example.com', role: 'Automation User', type: 'user' },
  { id: '23', name: 'Compliance', email: '', role: 'Test-role-viewer', type: 'group' },
  { id: '24', name: 'Priya Sharma', email: 'priya.sharma@example.com', role: 'Tenant Administrator', type: 'user' },
  { id: '25', name: 'Product Team', email: '', role: 'Automation Developer', type: 'group' },
  { id: '26', name: 'Marcus Johnson', email: 'marcus.johnson@example.com', role: 'Automation User', type: 'user' },
  ...
  { id: '30', name: 'David Kim', email: 'david.kim@example.com', role: 'Automation Developer', type: 'user' },
  { id: '31', name: 'Analytics', email: '', role: 'Automation User', type: 'group' },
  { id: '32', name: 'Olivia Brown', email: 'olivia.brown@example.com', role: 'Tenant Administrator', type: 'user' },
  { id: '33', name: 'Legal', email: '', role: 'Viewer', type: 'group' },
  { id: '34', name: 'Nathan Wright', email: 'nathan.wright@example.com', role: 'Automation User', type: 'user' },
  { id: '35', name: 'Release Mgmt', email: '', role: 'Automation Developer', type: 'group' },
  { id: '36', name: 'Fatima Al-Hassan', email: 'fatima.alhassan@example.com', role: 'Tenant Administrator', type: 'user' },
  { id: '37', name: 'Operations', email: '', role: 'Automation User', type: 'group' },
  { id: '38', name: 'Lucas Martin', email: 'lucas.martin@example.com', role: 'Automation Developer', type: 'user' },
  { id: '39', name: 'Design Systems', email: '', role: 'Viewer', type: 'group' },
  { id: '40', name: 'Isabella Davis', email: 'isabella.davis@example.com', role: 'Automation User', type: 'user' },
  { id: '41', name: 'Cloud Infra', email: '', role: 'Tenant Administrator', type: 'group' },
  { id: '42', name: 'Ethan Taylor', email: 'ethan.taylor@example.com', role: 'Automation Developer', type: 'user' },
  { id: '43', name: 'Procurement', email: '', role: 'Viewer', type: 'group' },
  { id: '44', name: 'Mia Anderson', email: 'mia.anderson@example.com', role: 'Tenant Administrator', type: 'user' },
  { id: '45', name: 'R&D Lab', email: '', role: 'Automation Developer', type: 'group' },
  { id: '46', name: 'Oscar Petrov', email: 'oscar.petrov@example.com', role: 'Automation User', type: 'user' },
  { id: '47', name: 'Executive Office', email: '', role: 'Viewer', type: 'group' },
  { id: '48', name: 'Grace Wilson', email: 'grace.wilson@example.com', role: 'Tenant Administrator', type: 'user' },
  { id: '49', name: 'Partner Integrations', email: '', role: 'Automation Developer', type: 'group' },
  { id: '50', name: 'Daniel Okafor', email: 'daniel.okafor@example.com', role: 'Automation User', type: 'user' },
];
...
function AdminPageDemo({ theme }: { theme: string }) {
  ...
  const columns: ColumnDef<UserRow>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <span className="text-future-foreground-muted">{row.original.role}</span>
      ),
    },
    {
      id: 'actions',
    ...
    <AdminLayout theme={theme}>
      ...
      <AdminContent>
        ...
        <AdminSidebar width={260}>
          ...
          <AdminSidebarNav items={navItems} selectedId={selectedTenant} onSelect={setSelectedTenant} />
        </AdminSidebar>
...
const products: Product[] = [
  { id: '1', name: 'Wireless Headphones', sku: 'WH-001', category: 'Electronics', price: 99.99, stock: 150, status: 'active', createdAt: '2026-01-10' },
  { id: '2', name: 'USB-C Cable', sku: 'UC-002', category: 'Accessories', price: 12.99, stock: 500, status: 'active', createdAt: '2026-01-09' },
  { id: '3', name: 'Laptop Stand', sku: 'LS-003', category: 'Accessories', price: 49.99, stock: 75, status: 'active', createdAt: '2026-01-08' },
  { id: '4', name: 'Mechanical Keyboard', sku: 'MK-004', category: 'Electronics', price: 149.99, stock: 0, status: 'draft', createdAt: '2026-01-07' },
  { id: '5', name: 'Monitor Light Bar', sku: 'ML-005', category: 'Electronics', price: 59.99, stock: 200, status: 'active', createdAt: '2026-01-06' },
  { id: '6', name: 'Webcam HD', sku: 'WC-006', category: 'Electronics', price: 79.99, stock: 45, status: 'active', createdAt: '2026-01-05' },
  { id: '7', name: 'Mouse Pad XL', sku: 'MP-007', category: 'Accessories', price: 24.99, stock: 300, status: 'active', createdAt: '2026-01-04' },
  { id: '8', name: 'Phone Holder', sku: 'PH-008', category: 'Accessories', price: 19.99, stock: 0, status: 'archived', createdAt: '2026-01-03' },
  { id: '9', name: 'Bluetooth Speaker', sku: 'BS-009', category: 'Electronics', price: 39.99, stock: 120, status: 'active', createdAt: '2026-01-02' },
  { id: '10', name: 'Screen Protector', sku: 'SP-010', category: 'Accessories', price: 9.99, stock: 1000, status: 'active', createdAt: '2026-01-01' },
  { id: '11', name: 'Ergonomic Mouse', sku: 'EM-011', category: 'Electronics', price: 69.99, stock: 85, status: 'active', createdAt: '2025-12-31' },
  { id: '12', name: 'HDMI Adapter', sku: 'HA-012', category: 'Accessories', price: 15.99, stock: 420, status: 'active', createdAt: '2025-12-30' },
  { id: '13', name: 'Portable SSD 1TB', sku: 'PS-013', category: 'Storage', price: 129.99, stock: 60, status: 'active', createdAt: '2025-12-29' },
  { id: '14', name: 'USB Hub 7-Port', sku: 'UH-014', category: 'Accessories', price: 34.99, stock: 190, status: 'active', createdAt: '2025-12-28' },
  { id: '15', name: 'Noise Cancelling Mic', sku: 'NM-015', category: 'Electronics', price: 89.99, stock: 0, status: 'draft', createdAt: '2025-12-27' },
  { id: '16', name: 'Desk Organizer', sku: 'DO-016', category: 'Accessories', price: 29.99, stock: 350, status: 'active', createdAt: '2025-12-26' },
  { id: '17', name: 'Wireless Charger', sku: 'WC-017', category: 'Electronics', price: 44.99, stock: 220, status: 'active', createdAt: '2025-12-25' },
  { id: '18', name: 'Cable Management Kit', sku: 'CM-018', category: 'Accessories', price: 18.99, stock: 600, status: 'active', createdAt: '2025-12-24' },
  { id: '19', name: '4K Monitor 27"', sku: 'MN-019', category: 'Electronics', price: 449.99, stock: 25, status: 'active', createdAt: '2025-12-23' },
  { id: '20', name: 'Wrist Rest Gel', sku: 'WR-020', category: 'Accessories', price: 14.99, stock: 0, status: 'archived', createdAt: '2025-12-22' },
  { id: '21', name: 'Smart Power Strip', sku: 'SP-021', category: 'Electronics', price: 39.99, stock: 175, status: 'active', createdAt: '2025-12-21' },
  { id: '22', name: 'Document Scanner', sku: 'DS-022', category: 'Electronics', price: 199.99, stock: 30, status: 'active', createdAt: '2025-12-20' },
  { id: '23', name: 'Privacy Screen Filter', sku: 'PF-023', category: 'Accessories', price: 42.99, stock: 95, status: 'active', createdAt: '2025-12-19' },
  { id: '24', name: 'USB Microphone', sku: 'UM-024', category: 'Electronics', price: 119.99, stock: 0, status: 'draft', createdAt: '2025-12-18' },
  { id: '25', name: 'Portable Monitor 15"', sku: 'PM-025', category: 'Electronics', price: 279.99, stock: 40, status: 'active', createdAt: '2025-12-17' },
  { id: '26', name: 'Ethernet Cable Cat6', sku: 'EC-026', category: 'Networking', price: 8.99, stock: 800, status: 'active', createdAt: '2025-12-16' },
  { id: '27', name: 'Wi-Fi 6 Router', sku: 'WR-027', category: 'Networking', price: 189.99, stock: 55, status: 'active', createdAt: '2025-12-15' },
  { id: '28', name: 'Webcam Ring Light', sku: 'RL-028', category: 'Accessories', price: 22.99, stock: 310, status: 'active', createdAt: '2025-12-14' },
  { id: '29', name: 'Thunderbolt Dock', sku: 'TD-029', category: 'Electronics', price: 249.99, stock: 15, status: 'active', createdAt: '2025-12-13' },
  { id: '30', name: 'Laptop Sleeve 14"', sku: 'LS-030', category: 'Accessories', price: 27.99, stock: 200, status: 'active', createdAt: '2025-12-12' },
  { id: '31', name: 'NVMe SSD 2TB', sku: 'NS-031', category: 'Storage', price: 179.99, stock: 70, status: 'active', createdAt: '2025-12-11' },
  { id: '32', name: 'Keyboard Cover', sku: 'KC-032', category: 'Accessories', price: 11.99, stock: 0, status: 'archived', createdAt: '2025-12-10' },
  { id: '33', name: 'Standing Desk Mat', sku: 'SM-033', category: 'Accessories', price: 54.99, stock: 130, status: 'active', createdAt: '2025-12-09' },
  { id: '34', name: 'USB Flash Drive 128GB', sku: 'UF-034', category: 'Storage', price: 16.99, stock: 450, status: 'active', createdAt: '2025-12-08' },
  { id: '35', name: 'Mesh Wi-Fi System', sku: 'MW-035', category: 'Networking', price: 299.99, stock: 20, status: 'active', createdAt: '2025-12-07' },
  { id: '36', name: 'Presentation Clicker', sku: 'PC-036', category: 'Electronics', price: 29.99, stock: 180, status: 'active', createdAt: '2025-12-06' },
  { id: '37', name: 'Monitor Arm Dual', sku: 'MA-037', category: 'Accessories', price: 79.99, stock: 65, status: 'active', createdAt: '2025-12-05' },
  { id: '38', name: 'Graphics Tablet', sku: 'GT-038', category: 'Electronics', price: 349.99, stock: 0, status: 'draft', createdAt: '2025-12-04' },
  { id: '39', name: 'MicroSD Card 256GB', sku: 'MC-039', category: 'Storage', price: 24.99, stock: 550, status: 'active', createdAt: '2025-12-03' },
  { id: '40', name: 'Surge Protector', sku: 'SP-040', category: 'Electronics', price: 35.99, stock: 230, status: 'active', createdAt: '2025-12-02' },
  { id: '41', name: 'Network Switch 8-Port', sku: 'NS-041', category: 'Networking', price: 49.99, stock: 90, status: 'active', createdAt: '2025-12-01' },
  { id: '42', name: 'Trackpad Wireless', sku: 'TW-042', category: 'Electronics', price: 79.99, stock: 105, status: 'active', createdAt: '2025-11-30' },
  { id: '43', name: 'Display Cleaning Kit', sku: 'DC-043', category: 'Accessories', price: 9.99, stock: 700, status: 'active', createdAt: '2025-11-29' },
  { id: '44', name: 'External Blu-ray Drive', sku: 'BD-044', category: 'Storage', price: 89.99, stock: 35, status: 'active', createdAt: '2025-11-28' },
  { id: '45', name: 'PoE Injector', sku: 'PI-045', category: 'Networking', price: 19.99, stock: 160, status: 'active', createdAt: '2025-11-27' },
  { id: '46', name: 'Webcam Privacy Cover', sku: 'WP-046', category: 'Accessories', price: 5.99, stock: 0, status: 'archived', createdAt: '2025-11-26' },
  { id: '47', name: 'Docking Station USB-C', sku: 'DS-047', category: 'Electronics', price: 169.99, stock: 50, status: 'active', createdAt: '2025-11-25' },
  { id: '48', name: 'Fiber Patch Cable', sku: 'FP-048', category: 'Networking', price: 13.99, stock: 380, status: 'active', createdAt: '2025-11-24' },
  { id: '49', name: 'Portable HDD 4TB', sku: 'PH-049', category: 'Storage', price: 109.99, stock: 0, status: 'draft', createdAt: '2025-11-23' },
  { id: '50', name: 'Laptop Cooling Pad', sku: 'LC-050', category: 'Accessories', price: 32.99, stock: 275, status: 'active', createdAt: '2025-11-22' },
];
...
function DataManagementDemo({ theme }: { theme: string }) {
  ...
  const productColumns: ColumnDef<Product, unknown>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => <span className="text-future-foreground-muted">{row.getValue('category')}</span>,
    },
    {
      accessorKey: 'price',
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <span className={stock === 0 ? 'font-medium text-red-400' : 'text-future-foreground-muted'}>
    ...
    },
    {
      ...
      cell: ({ row }) => <span className="text-future-foreground-muted">{row.getValue('createdAt')}</span>,
    },
    {
      id: 'actions',
      cell: () => (
        ...
        <div className="flex items-center justify-between border-b border-future-border-subtle px-6 py-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
              ...
              <DialogContent className={cn(themeClass, 'border-future-border bg-future-surface-raised text-future-foreground')}>
                <DialogHeader>
                ...
                <div className="flex flex-col gap-4 py-4">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <Select>
                      ...
                      <SelectContent className={cn(themeClass, 'border-future-border bg-future-surface-overlay text-future-foreground')}>
