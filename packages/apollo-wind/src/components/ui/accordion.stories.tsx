  ...
  render: () => (
    <Accordion type="multiple" defaultValue={['item-1', 'item-3']} className="w-full max-w-lg">
      <AccordionItem value="item-1">
        ...
        <AccordionContent>
          This accordion allows multiple items to be open at the same time. Try opening several
          sections.
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-2">
        <AccordionTrigger>Second section</AccordionTrigger>
        <AccordionContent>Opening this section will not close the others.</AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-3">
        <AccordionTrigger>Third section</AccordionTrigger>
        <AccordionContent>Multiple sections can remain expanded simultaneously.</AccordionContent>
      </AccordionItem>
    </Accordion>
  ),
};
  ...
  render: () => (
    <Accordion type="single" collapsible className="w-full max-w-lg">
      <AccordionItem value="item-1">
        ...
        <AccordionContent>This section is available and can be expanded.</AccordionContent>
      </AccordionItem>
      ...
      <AccordionItem value="item-4" disabled>
        ...
        <AccordionContent>This content requires a plan upgrade.</AccordionContent>
      </AccordionItem>
    </Accordion>
  ),
};
  ...
  render: () => (
    <Accordion type="single" collapsible className="w-full max-w-lg">
      <AccordionItem value="item-1" className="border rounded-lg px-4 mb-2">
        ...
        <AccordionContent>
          We offer a 30-day money-back guarantee on all plans. If you&apos;re not satisfied, contact
      ...
      <AccordionItem value="item-3" className="border rounded-lg px-4">
        ...
        <AccordionContent>
          Yes, we offer volume discounts for teams of 10 or more. Contact our sales team for a
          custom quote.
        </AccordionContent>
      </AccordionItem>
    </Accordion>
...
export const Card = {
  ...
  render: () => (
    <Accordion type="single" collapsible className="w-full max-w-lg">
      <AccordionItem
        value="item-1"
        className="mb-3 rounded-lg border bg-card px-4 shadow-sm [&:not(:last-child)]:border-b"
      >
        <AccordionTrigger className="hover:no-underline">
          <div className="flex flex-col items-start gap-1">
            <span className="text-sm font-medium">Getting Started</span>
            <span className="text-xs text-muted-foreground font-normal">
              Learn the basics of setting up your workspace
            </span>
          </div>
        </AccordionTrigger>
        <AccordionContent>
      ...
      >
        ...
        <AccordionContent>
          <div className="space-y-2 text-sm text-muted-foreground">
            <p>
              Use our REST API to integrate with any external service. Authentication is handled via
              API keys that you can generate from your account settings.
            </p>
          </div>
        </AccordionContent>
      </AccordionItem>
      <AccordionItem
        value="item-3"
        className="rounded-lg border bg-card px-4 shadow-sm [&:not(:last-child)]:border-b"
      >
        <AccordionTrigger className="hover:no-underline">
          <div className="flex flex-col items-start gap-1">
            <span className="text-sm font-medium">Deployment</span>
            <span className="text-xs text-muted-foreground font-normal">
              Deploy your automations to production
            </span>
          </div>
        </AccordionTrigger>
        <AccordionContent>
          <div className="space-y-2 text-sm text-muted-foreground">
            <p>
              Publish your automation to a production environment with a single click. Monitor
              performance and logs from the dashboard.
            </p>
          </div>
        </AccordionContent>
      </AccordionItem>
      ...
      <div>
        ...
        <Accordion type="single" collapsible className="w-full max-w-lg">
          <AccordionItem value="q1">
            ...
            <AccordionContent>
              Apollo is UiPath&apos;s open-source design system providing a unified component
              library for building consistent user interfaces across products.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="q2">
            <AccordionTrigger>Which frameworks are supported?</AccordionTrigger>
            <AccordionContent>
              Apollo supports React as the primary framework, with Tailwind CSS + shadcn/ui for
              modern styling. Web Components are also available for cross-framework usage.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="q4">
            ...
            <AccordionContent>
              Yes! Apollo is open source. Check the contribution guidelines in the repository for
              information on how to submit components, bug fixes, or documentation improvements.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </div>
