...
export const Basic = {
  ...
  render: () => (
    <Pagination>
      <PaginationContent>
        <PaginationItem>
          <PaginationPrevious href="#demo" />
        </PaginationItem>
        <PaginationItem>
          <PaginationLink href="#demo">1</PaginationLink>
        </PaginationItem>
        <PaginationItem>
          <PaginationLink href="#demo" isActive>
            2
          </PaginationLink>
        </PaginationItem>
        <PaginationItem>
          <PaginationLink href="#demo">3</PaginationLink>
        </PaginationItem>
        <PaginationItem>
          <PaginationEllipsis />
        </PaginationItem>
        <PaginationItem>
          <PaginationLink href="#demo">10</PaginationLink>
        </PaginationItem>
        <PaginationItem>
          <PaginationNext href="#demo" />
        </PaginationItem>
      </PaginationContent>
    </Pagination>
  ),
