...
export const DatePicker = React.forwardRef<HTMLButtonElement, DatePickerProps>(function DatePicker(
  ...
  return (
    <>
      ...
      <FormFieldError id={validationId} data-slot="date-picker-error" className="mt-1">
        {error}
      </FormFieldError>
    </>
  );
  ...
  function DateRangePicker(
    ...
    return (
      <>
        ...
        <FormFieldError id={validationId} data-slot="date-range-picker-error" className="mt-1">
          {error}
        </FormFieldError>
      </>
    );
