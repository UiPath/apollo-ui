      ...
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-8">
        ...
        <Accordion
          className={`flex flex-col ${
            isFlowDense
              ? 'gap-2 [&>div]:rounded-lg [&>div]:px-4 [&>div>h3>button]:py-3 [&>div>h3>button>span]:gap-2 [&>div>h3>button>span>span:first-child]:size-7 [&>div>h3>button>span>span:last-child>span:first-child]:text-base [&>div>h3>button>span>span:last-child>span:first-child]:leading-5 [&>div>h3>button>span>span:last-child>span:last-child]:text-xs [&>div>h3>button>span>span:last-child>span:last-child]:leading-4 [&>div>div>div]:gap-3 [&>div>div>div]:pb-4 [&>div>div>div>div:first-child]:rounded-lg [&>div>div>div>div:first-child]:p-4 [&>div>div>div>div:first-child]:shadow-none [&>div>div>div_input]:h-8 [&>div>div>div_button]:min-h-8 [&>div>div>div_label]:text-xs [&>div>div>div_table]:text-xs'
              : 'gap-4'
          }`}
