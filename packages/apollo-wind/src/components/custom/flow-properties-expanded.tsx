...
function SectionHeader({ title }: { title: string }) {
  return (
    <div className="flex items-center gap-1 px-2 py-1">
      ...
      <span className="text-sm font-semibold leading-5 text-future-foreground">
        {title}
      </span>
    </div>
  );
...
function CodeViewer({
  ...
  return (
    <div
      className={cn(
        'flex flex-1 gap-6 overflow-auto px-5 py-4 text-sm leading-6',
        className
      )}
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between border-b border-future-border px-4 py-2">
        <div className="flex items-center gap-2">
          {/* Dock button */}
          <button className="flex h-10 w-10 items-center justify-center rounded-xl bg-future-surface-overlay text-future-foreground-muted hover:text-future-foreground">
            <PanelRightOpen className="h-5 w-5" />
          </button>
          {/* Layout toggle: columns / rows */}
          <div className="flex h-10 items-center rounded-xl border border-future-border-deep bg-future-surface-overlay p-1">
            <button className="flex h-8 w-8 items-center justify-center rounded-[10px] text-future-foreground-muted transition-colors hover:text-future-foreground">
              <Columns2 className="h-5 w-5" />
            </button>
            <button className="flex h-8 w-8 items-center justify-center rounded-[10px] border border-future-border bg-future-surface text-future-foreground">
              <Rows2 className="h-5 w-5" />
            </button>
          </div>
        </div>
        {/* Run node button */}
        <button className="flex h-10 items-center gap-2 rounded-xl bg-future-accent px-4 py-2 text-sm font-semibold leading-5 text-future-foreground-inverse">
