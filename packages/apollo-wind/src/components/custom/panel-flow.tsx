    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <button className="flex h-8 w-8 items-center justify-center rounded-lg text-future-foreground-muted hover:text-future-foreground">
        ...
        <button className="flex h-8 w-8 items-center justify-center rounded-full bg-future-accent text-future-foreground-on-accent">
