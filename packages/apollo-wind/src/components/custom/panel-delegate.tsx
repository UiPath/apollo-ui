          ...
          {item.children?.map((child) => (
            <button
              ...
              className={cn(
                ...
                selectedChildId === child.id && 'bg-future-surface-hover text-future-foreground-on-accent'
              )}
            ...
            {panelOpen && (
              <div className="flex flex-1 items-center justify-between">
                <div className="flex items-center gap-[18px]">
                  <button className="text-future-foreground-muted transition-colors hover:text-future-foreground">
