...
export function ChatComposer({
  ...
  return (
    <div
      className={cn(
        'w-full max-w-[800px] rounded-[32px] bg-gradient-to-b from-future-surface to-future-surface-raised p-2',
        className
      )}
    >
      <div className="flex min-h-[124px] flex-col justify-between rounded-3xl border border-future-border bg-future-surface-overlay pb-3 pl-4 pr-3 pt-4">
        {/* Text area */}
        <textarea
