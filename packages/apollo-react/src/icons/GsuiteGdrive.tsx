// Auto-generated from studio-activities-icon-sets/classic-icons-gsuite-apps/gsuite-gdrive.svg
import React from 'react';

export interface GsuiteGdriveProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
GsuiteGdrive.displayName = 'GsuiteGdrive';

export default GsuiteGdrive;
