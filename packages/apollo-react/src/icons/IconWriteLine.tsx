// Auto-generated from activities/icon-write-line.svg
import React from 'react';

export interface IconWriteLineProps extends React.SVGProps<SVGSVGElement> {}

export const IconWriteLine = React.forwardRef<SVGSVGElement, IconWriteLineProps>(
  (props, ref) => (
...
IconWriteLine.displayName = 'IconWriteLine';

export default IconWriteLine;
