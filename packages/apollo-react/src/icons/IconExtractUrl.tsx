// Auto-generated from classic-icons/icon-extract-url.svg
import React from 'react';

export interface IconExtractUrlProps extends React.SVGProps<SVGSVGElement> {}

export const IconExtractUrl = React.forwardRef<SVGSVGElement, IconExtractUrlProps>(
  (props, ref) => (
...
<rect width="24" height="24" fill="white" transform="translate(-0.444336 0.117676)"/>
</clipPath>
</defs>
    </svg>
  )
...
IconExtractUrl.displayName = 'IconExtractUrl';

export default IconExtractUrl;
