// Auto-generated from activities/icon-do-while.svg
import React from 'react';

export interface IconDoWhileProps extends React.SVGProps<SVGSVGElement> {}

export const IconDoWhile = React.forwardRef<SVGSVGElement, IconDoWhileProps>(
  (props, ref) => (
...
IconDoWhile.displayName = 'IconDoWhile';

export default IconDoWhile;
