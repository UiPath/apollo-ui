...
export interface UIAutomationTakeScreenshotProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const UIAutomationTakeScreenshot = React.forwardRef<SVGSVGElement, UIAutomationTakeScreenshotProps>(
  ({ size, ...props }, ref) => (
