...
export interface SentimentDissatisfiedProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const SentimentDissatisfied = React.forwardRef<SVGSVGElement, SentimentDissatisfiedProps>(
  ({ size, ...props }, ref) => (
