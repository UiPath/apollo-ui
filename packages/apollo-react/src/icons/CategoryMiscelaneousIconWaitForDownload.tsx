// Auto-generated from activities/category-miscelaneous-icon-wait-for-download.svg
import React from 'react';

export interface CategoryMiscelaneousIconWaitForDownloadProps extends React.SVGProps<SVGSVGElement> {}

export const CategoryMiscelaneousIconWaitForDownload = React.forwardRef<SVGSVGElement, CategoryMiscelaneousIconWaitForDownloadProps>(
  (props, ref) => (
...
CategoryMiscelaneousIconWaitForDownload.displayName = 'CategoryMiscelaneousIconWaitForDownload';

export default CategoryMiscelaneousIconWaitForDownload;
