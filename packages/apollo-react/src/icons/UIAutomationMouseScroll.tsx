...
export interface UIAutomationMouseScrollProps
...
export const UIAutomationMouseScroll = React.forwardRef<
  SVGSVGElement,
  UIAutomationMouseScrollProps
>(({ size, ...props }, ref) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
...
UIAutomationMouseScroll.displayName = 'UIAutomationMouseScroll';

export default UIAutomationMouseScroll;
