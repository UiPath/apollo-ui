// Auto-generated from color.svg
import React from 'react';

export interface IconColorProps extends React.SVGProps<SVGSVGElement> {}

export const IconColor = React.forwardRef<SVGSVGElement, IconColorProps>(
  (props, ref) => (
