// Auto-generated from action/thumb-down.svg
import React from 'react';

export interface ThumbDownProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const ThumbDown = React.forwardRef<SVGSVGElement, ThumbDownProps>(
  ({ size, ...props }, ref) => (
