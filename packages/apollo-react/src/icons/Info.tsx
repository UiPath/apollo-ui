// Auto-generated from indicator-and-alert/info.svg
import React from 'react';

export interface InfoProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const Info = React.forwardRef<SVGSVGElement, InfoProps>(({ size, ...props }, ref) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
