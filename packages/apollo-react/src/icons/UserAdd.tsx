// Auto-generated from social/user-add.svg
import React from 'react';

export interface UserAddProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const UserAdd = React.forwardRef<SVGSVGElement, UserAddProps>(({ size, ...props }, ref) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
