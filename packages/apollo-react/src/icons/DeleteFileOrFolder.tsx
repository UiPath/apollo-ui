...
export interface DeleteFileOrFolderProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const DeleteFileOrFolder = React.forwardRef<SVGSVGElement, DeleteFileOrFolderProps>(
  ({ size, ...props }, ref) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" ref={ref} {...props} width={size ?? 24} height={size ?? 24}>
      <path d="M8 8H11L17 14V15H15H10V10H8V20H13V22H7.99C6.89 22 6 21.1 6 20L6.01 10C6.01 8.9 6.9 8 8 8Z" fill="currentColor"/>
