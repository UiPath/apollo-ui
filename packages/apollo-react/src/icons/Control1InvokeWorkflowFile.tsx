...
export interface Control1InvokeWorkflowFileProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const Control1InvokeWorkflowFile = React.forwardRef<SVGSVGElement, Control1InvokeWorkflowFileProps>(
  ({ size, ...props }, ref) => (
