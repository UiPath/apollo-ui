// Auto-generated from classic-icons/icon-gdrive.svg
import React from 'react';

export interface IconGdriveProps extends React.SVGProps<SVGSVGElement> {}

export const IconGdrive = React.forwardRef<SVGSVGElement, IconGdriveProps>(
  (props, ref) => (
...
IconGdrive.displayName = 'IconGdrive';

export default IconGdrive;
