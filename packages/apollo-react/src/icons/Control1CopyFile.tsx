...
export interface Control1CopyFileProps extends React.SVGProps<SVGSVGElement> {}
...
Control1CopyFile.displayName = 'Control1CopyFile';

export default Control1CopyFile;
