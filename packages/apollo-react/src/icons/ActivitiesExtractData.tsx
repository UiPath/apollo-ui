// Auto-generated from activities/activities-extract-data.svg
import React from 'react';

export interface ActivitiesExtractDataProps extends React.SVGProps<SVGSVGElement> {}

export const ActivitiesExtractData = React.forwardRef<SVGSVGElement, ActivitiesExtractDataProps>(
  (props, ref) => (
...
ActivitiesExtractData.displayName = 'ActivitiesExtractData';

export default ActivitiesExtractData;
