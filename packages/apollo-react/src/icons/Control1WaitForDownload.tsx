...
export interface Control1WaitForDownloadProps
...
export const Control1WaitForDownload = React.forwardRef<
  SVGSVGElement,
  Control1WaitForDownloadProps
>(({ size, ...props }, ref) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
...
Control1WaitForDownload.displayName = 'Control1WaitForDownload';

export default Control1WaitForDownload;
