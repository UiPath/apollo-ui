// Auto-generated from studio-activities-icon-sets/activities-ui-automation/ui-automation-extract-data.svg
import React from 'react';

export interface UIAutomationExtractDataProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const UIAutomationExtractData = React.forwardRef<SVGSVGElement, UIAutomationExtractDataProps>(
  ({ size, ...props }, ref) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" ref={ref} {...props} width={size ?? 24} height={size ?? 24}>
      <g clipPath="url(#clip0_4117_2288)">
...
UIAutomationExtractData.displayName = 'UIAutomationExtractData';

export default UIAutomationExtractData;
