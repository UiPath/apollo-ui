  ...
  ({ size, ...props }, ref) => (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4 3C3.44772 3 3 3.44772 3 4V19C3 19.5523 3.44772 20 4 20H20C20.5523 20 21 19.5523 21 19V18H11V15H16V13H11V10H21V4C21 3.44772 20.5523 3 20 3H4ZM5 5V8H9V5H5ZM5 10H9V13H5V10ZM5 15H9V18H5V15ZM11 5V8H19V5H11Z"
        fill="currentColor"
      />
