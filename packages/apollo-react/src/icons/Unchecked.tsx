// Auto-generated from favourite/unchecked.svg
import React from 'react';

export interface UncheckedProps extends React.SVGProps<SVGSVGElement> {}

export const Unchecked = React.forwardRef<SVGSVGElement, UncheckedProps>(
  (props, ref) => (
