// Auto-generated from activities/icon-uipath.svg
import React from 'react';

export interface IconUipathProps extends React.SVGProps<SVGSVGElement> {}

export const IconUipath = React.forwardRef<SVGSVGElement, IconUipathProps>(
  (props, ref) => (
...
IconUipath.displayName = 'IconUipath';
