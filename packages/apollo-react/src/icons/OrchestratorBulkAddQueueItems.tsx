...
export interface OrchestratorBulkAddQueueItemsProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const OrchestratorBulkAddQueueItems = React.forwardRef<SVGSVGElement, OrchestratorBulkAddQueueItemsProps>(
  ({ size, ...props }, ref) => (
