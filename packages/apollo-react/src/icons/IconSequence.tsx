// Auto-generated from activities/icon-sequence.svg
import React from 'react';

export interface IconSequenceProps extends React.SVGProps<SVGSVGElement> {}

export const IconSequence = React.forwardRef<SVGSVGElement, IconSequenceProps>(
  (props, ref) => (
...
IconSequence.displayName = 'IconSequence';
