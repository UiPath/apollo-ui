...
export interface DataTypesIntegerProps extends React.SVGProps<SVGSVGElement> {}
...
DataTypesInteger.displayName = 'DataTypesInteger';

export default DataTypesInteger;
