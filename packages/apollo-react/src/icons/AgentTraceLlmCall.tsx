...
export interface AgentTraceLlmCallProps extends React.SVGProps<SVGSVGElement> {}
...
AgentTraceLlmCall.displayName = 'AgentTraceLlmCall';

export default AgentTraceLlmCall;
