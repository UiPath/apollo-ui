...
export interface AgentTraceConversationUserMessageProps extends React.SVGProps<SVGSVGElement> {}

export const AgentTraceConversationUserMessage = React.forwardRef<SVGSVGElement, AgentTraceConversationUserMessageProps>(
  (props, ref) => (
