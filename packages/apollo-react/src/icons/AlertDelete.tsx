...
export const AlertDelete = React.forwardRef<SVGSVGElement, AlertDeleteProps>(
  ({ size, ...props }, ref) => (
    ...
    >
      ...
      />
      <path
        d="M15.4297 16.1436C15.4297 16.7721 14.9147 17.2861 14.2861 17.2861H9.71484C9.08626 17.2861 8.57229 16.7721 8.57227 16.1436V9.28613H15.4297V16.1436ZM9.71387 16.1436H14.2861V10.4287H9.71387V16.1436ZM13.4287 7L14 7.57129H16V8.71484H8V7.57129H10L10.5713 7H13.4287Z"
