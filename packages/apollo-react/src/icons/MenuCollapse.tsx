...
export const MenuCollapse = React.forwardRef<SVGSVGElement, MenuCollapseProps>(
  ({ size, ...props }, ref) => (
    ...
    >
      <path
        d="M2 18H16.4444V15.8333H2V18ZM2 12.5833H13.1111V10.4167H2V12.5833ZM2 5V7.16667H16.4444V5H2ZM22 15.3892L18.0222 11.5L22 7.61083L20.4333 6.08333L14.8778 11.5L20.4333 16.9167L22 15.3892Z"
        fill="currentColor"
      />
    </svg>
  )
