// Auto-generated from activities/category-queues-icon-get-queue-items.svg
import React from 'react';

export interface CategoryQueuesIconGetQueueItemsProps extends React.SVGProps<SVGSVGElement> {}

export const CategoryQueuesIconGetQueueItems = React.forwardRef<SVGSVGElement, CategoryQueuesIconGetQueueItemsProps>(
  (props, ref) => (
...
CategoryQueuesIconGetQueueItems.displayName = 'CategoryQueuesIconGetQueueItems';

export default CategoryQueuesIconGetQueueItems;
