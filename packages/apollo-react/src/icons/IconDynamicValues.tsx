// Auto-generated from classic-icons/icon-dynamic-values.svg
import React from 'react';

export interface IconDynamicValuesProps extends React.SVGProps<SVGSVGElement> {}

export const IconDynamicValues = React.forwardRef<SVGSVGElement, IconDynamicValuesProps>(
  (props, ref) => (
...
IconDynamicValues.displayName = 'IconDynamicValues';

export default IconDynamicValues;
