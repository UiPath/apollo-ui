...
export interface ExpressionVariableCreateProps
...
export const ExpressionVariableCreate = React.forwardRef<
  SVGSVGElement,
  ExpressionVariableCreateProps
>(({ size, ...props }, ref) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
