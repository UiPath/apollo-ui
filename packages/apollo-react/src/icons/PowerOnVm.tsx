...
export interface PowerOnVmProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const PowerOnVm = React.forwardRef<SVGSVGElement, PowerOnVmProps>(
  ({ size, ...props }, ref) => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
PowerOnVm.displayName = 'PowerOnVm';
