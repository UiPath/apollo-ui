...
export interface SuspendVmProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
  ...
  ({ size, ...props }, ref) => (
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M15 14.9687V13H22V14.9687L19.8333 17.5L22 20.0312V22L15 22V20.0312L17.1667 17.5L15 14.9687ZM16.9444 14.75L20.0556 14.75L18.5 16.25L16.9444 14.75ZM20.0556 20.25H16.9444L18.5 18.75L20.0556 20.25Z"
        fill="#1976D2"
      />
    </svg>
  )
