// Auto-generated from get-vm.svg
import React from 'react';

export interface GetVmProps extends React.SVGProps<SVGSVGElement> {}

export const GetVm = React.forwardRef<SVGSVGElement, GetVmProps>(
  (props, ref) => (
