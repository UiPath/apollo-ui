// Auto-generated from data-type/integer.svg
import React from 'react';

export interface IntegerProps extends React.SVGProps<SVGSVGElement> {}

export const Integer = React.forwardRef<SVGSVGElement, IntegerProps>(
  (props, ref) => (
