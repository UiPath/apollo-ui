...
export interface PowerOffVmProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const PowerOffVm = React.forwardRef<SVGSVGElement, PowerOffVmProps>(
  ({ size, ...props }, ref) => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <path
        ...
        strokeWidth="2"
      />
      <rect x="15" y="15" width="7" height="7" fill="#CC3D45" />
    </svg>
  )
);

PowerOffVm.displayName = 'PowerOffVm';

export default PowerOffVm;
