// Auto-generated from editor/border/border-clear.svg
import React from 'react';

export interface BorderClearProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
