// Auto-generated from object/data-type/type-array.svg
import React from 'react';

export interface TypeArrayProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const TypeArray = React.forwardRef<SVGSVGElement, TypeArrayProps>(
  ({ size, ...props }, ref) => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
