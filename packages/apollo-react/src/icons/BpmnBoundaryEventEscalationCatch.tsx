...
export interface BpmnBoundaryEventEscalationCatchProps
...
export const BpmnBoundaryEventEscalationCatch = React.forwardRef<
  SVGSVGElement,
  BpmnBoundaryEventEscalationCatchProps
>(({ size, ...props }, ref) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
