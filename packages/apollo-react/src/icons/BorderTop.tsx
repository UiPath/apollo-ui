// Auto-generated from editor/border/border-top.svg
import React from 'react';

export interface BorderTopProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const BorderTop = React.forwardRef<SVGSVGElement, BorderTopProps>(
  ({ size, ...props }, ref) => (
