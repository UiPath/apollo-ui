...
export interface PipelinesMoveProjectProps extends React.SVGProps<SVGSVGElement> {}
...
PipelinesMoveProject.displayName = 'PipelinesMoveProject';

export default PipelinesMoveProject;
