...
export interface FTPFTPConnectionProps extends React.SVGProps<SVGSVGElement> {}
...
FTPFTPConnection.displayName = 'FTPFTPConnection';

export default FTPFTPConnection;
