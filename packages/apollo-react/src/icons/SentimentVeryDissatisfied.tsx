// Auto-generated from social/sentiment-very-dissatisfied.svg
import React from 'react';

export interface SentimentVeryDissatisfiedProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
