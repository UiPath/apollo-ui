// Auto-generated from activities/icon-http-client.svg
import React from 'react';

export interface IconHttpClientProps extends React.SVGProps<SVGSVGElement> {}

export const IconHttpClient = React.forwardRef<SVGSVGElement, IconHttpClientProps>(
  (props, ref) => (
...
IconHttpClient.displayName = 'IconHttpClient';

export default IconHttpClient;
