// Auto-generated from activities/icon-trigger-activity.svg
import React from 'react';

export interface IconTriggerActivityProps extends React.SVGProps<SVGSVGElement> {}

export const IconTriggerActivity = React.forwardRef<SVGSVGElement, IconTriggerActivityProps>(
  (props, ref) => (
...
IconTriggerActivity.displayName = 'IconTriggerActivity';

export default IconTriggerActivity;
