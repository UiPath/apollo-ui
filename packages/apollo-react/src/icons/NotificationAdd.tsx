// Auto-generated from indicator-and-alert/notification-add.svg
import React from 'react';

export interface NotificationAddProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const NotificationAdd = React.forwardRef<SVGSVGElement, NotificationAddProps>(
  ({ size, ...props }, ref) => (
