// Auto-generated from social/user-group-remove.svg
import React from 'react';

export interface UserGroupRemoveProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
