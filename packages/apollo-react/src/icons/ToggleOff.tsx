// Auto-generated from toggle/toggle/toggle-off.svg
import React from 'react';

export interface ToggleOffProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const ToggleOff = React.forwardRef<SVGSVGElement, ToggleOffProps>(
  ({ size, ...props }, ref) => (
