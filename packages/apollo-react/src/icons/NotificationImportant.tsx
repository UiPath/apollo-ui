// Auto-generated from indicator-and-alert/notification-important.svg
import React from 'react';

export interface NotificationImportantProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
