// Auto-generated from studio-icons/wait-for-download.svg
import React from 'react';

export interface WaitForDownloadProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const WaitForDownload = React.forwardRef<SVGSVGElement, WaitForDownloadProps>(
  ({ size, ...props }, ref) => (
...
WaitForDownload.displayName = 'WaitForDownload';
