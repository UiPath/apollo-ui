// Auto-generated from editor/border/border-left.svg
import React from 'react';

export interface BorderLeftProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
