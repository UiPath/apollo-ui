// Auto-generated from action/convert.svg
import React from 'react';

export interface ConvertProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const Convert = React.forwardRef<SVGSVGElement, ConvertProps>(({ size, ...props }, ref) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
