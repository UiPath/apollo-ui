...
export interface PriorityMediumHighProps extends React.SVGProps<SVGSVGElement> {}
...
PriorityMediumHigh.displayName = 'PriorityMediumHigh';

export default PriorityMediumHigh;
