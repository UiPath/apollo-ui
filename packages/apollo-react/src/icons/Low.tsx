// Auto-generated from priority/low.svg
import React from 'react';

export interface LowProps extends React.SVGProps<SVGSVGElement> {}

export const Low = React.forwardRef<SVGSVGElement, LowProps>(
  (props, ref) => (
