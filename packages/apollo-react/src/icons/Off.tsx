// Auto-generated from toggle/off.svg
import React from 'react';

export interface OffProps extends React.SVGProps<SVGSVGElement> {}

export const Off = React.forwardRef<SVGSVGElement, OffProps>(
  (props, ref) => (
