// Auto-generated from indicator-and-alert/alert-error-solid.svg
import React from 'react';

export interface AlertErrorSolidProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
