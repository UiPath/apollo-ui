// Auto-generated from icon-edit-project-properties.svg
import React from 'react';

export interface IconEditProjectPropertiesProps extends React.SVGProps<SVGSVGElement> {}

export const IconEditProjectProperties = React.forwardRef<SVGSVGElement, IconEditProjectPropertiesProps>(
  (props, ref) => (
...
IconEditProjectProperties.displayName = 'IconEditProjectProperties';

export default IconEditProjectProperties;
