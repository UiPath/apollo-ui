// Auto-generated from activities/icon-hash-file.svg
import React from 'react';

export interface IconHashFileProps extends React.SVGProps<SVGSVGElement> {}

export const IconHashFile = React.forwardRef<SVGSVGElement, IconHashFileProps>(
  (props, ref) => (
...
IconHashFile.displayName = 'IconHashFile';

export default IconHashFile;
