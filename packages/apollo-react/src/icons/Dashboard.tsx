  ...
  ({ size, ...props }, ref) => (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M3 3V21H11.1V3H3ZM9.1 5H5V19H9.1V5Z"
        fill="currentColor"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12.8999 11.1V21H20.9999V11.1H12.8999ZM18.9999 13.1H14.8999V19H18.9999V13.1Z"
        fill="currentColor"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12.8999 9.3V3H20.9999V9.3H12.8999ZM14.8999 5H18.9999V7.3H14.8999V5Z"
        fill="currentColor"
      />
    </svg>
  )
