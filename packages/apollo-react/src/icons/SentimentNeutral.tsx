...
export interface SentimentNeutralProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const SentimentNeutral = React.forwardRef<SVGSVGElement, SentimentNeutralProps>(
  ({ size, ...props }, ref) => (
