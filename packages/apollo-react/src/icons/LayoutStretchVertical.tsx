...
export interface LayoutStretchVerticalProps
  ...
  ({ size, ...props }, ref) => (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M21 4.5L3 4.5V3H21V4.5ZM21 21L3 21V19.5H21V21ZM4.5 10.5L19.5 10.5V7.5L4.5 7.5L4.5 10.5ZM4.5 16.5L19.5 16.5V13.5L4.5 13.5L4.5 16.5Z"
        fill="currentColor"
      />
    </svg>
  )
