// Auto-generated from logic/delay.svg
import React from 'react';

export interface DelayProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const Delay = React.forwardRef<SVGSVGElement, DelayProps>(({ size, ...props }, ref) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
