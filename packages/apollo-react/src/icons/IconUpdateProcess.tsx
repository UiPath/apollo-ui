// Auto-generated from icon-update-process.svg
import React from 'react';

export interface IconUpdateProcessProps extends React.SVGProps<SVGSVGElement> {}

export const IconUpdateProcess = React.forwardRef<SVGSVGElement, IconUpdateProcessProps>(
  (props, ref) => (
...
IconUpdateProcess.displayName = 'IconUpdateProcess';

export default IconUpdateProcess;
