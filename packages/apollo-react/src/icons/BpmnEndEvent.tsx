// Auto-generated from bpmn-end-event.svg
import React from 'react';

export interface BpmnEndEventProps extends React.SVGProps<SVGSVGElement> {}

export const BpmnEndEvent = React.forwardRef<SVGSVGElement, BpmnEndEventProps>(
  (props, ref) => (
...
BpmnEndEvent.displayName = 'BpmnEndEvent';
