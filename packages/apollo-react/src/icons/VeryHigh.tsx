// Auto-generated from priority/very-high.svg
import React from 'react';

export interface VeryHighProps extends React.SVGProps<SVGSVGElement> {}

export const VeryHigh = React.forwardRef<SVGSVGElement, VeryHighProps>(
  (props, ref) => (
