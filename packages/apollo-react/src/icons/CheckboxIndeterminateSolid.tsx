...
export interface CheckboxIndeterminateSolidProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const CheckboxIndeterminateSolid = React.forwardRef<SVGSVGElement, CheckboxIndeterminateSolidProps>(
  ({ size, ...props }, ref) => (
