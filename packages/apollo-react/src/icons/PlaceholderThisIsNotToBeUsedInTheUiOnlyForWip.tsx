// Auto-generated from placeholder-this-is-not-to-be-used-in-the-ui-only-for-wip.svg
import React from 'react';

export interface PlaceholderThisIsNotToBeUsedInTheUiOnlyForWipProps extends React.SVGProps<SVGSVGElement> {}

export const PlaceholderThisIsNotToBeUsedInTheUiOnlyForWip = React.forwardRef<SVGSVGElement, PlaceholderThisIsNotToBeUsedInTheUiOnlyForWipProps>(
  (props, ref) => (
...
PlaceholderThisIsNotToBeUsedInTheUiOnlyForWip.displayName = 'PlaceholderThisIsNotToBeUsedInTheUiOnlyForWip';

export default PlaceholderThisIsNotToBeUsedInTheUiOnlyForWip;
