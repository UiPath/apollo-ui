...
export interface AccountSwitchProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const AccountSwitch = React.forwardRef<SVGSVGElement, AccountSwitchProps>(
  ({ size, ...props }, ref) => (
