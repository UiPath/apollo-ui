// Auto-generated from activities/icon-delay.svg
import React from 'react';

export interface IconDelayProps extends React.SVGProps<SVGSVGElement> {}

export const IconDelay = React.forwardRef<SVGSVGElement, IconDelayProps>(
  (props, ref) => (
...
IconDelay.displayName = 'IconDelay';
