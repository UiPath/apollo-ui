// Auto-generated from activities/activities-gettext.svg
import React from 'react';

export interface ActivitiesGettextProps extends React.SVGProps<SVGSVGElement> {}

export const ActivitiesGettext = React.forwardRef<SVGSVGElement, ActivitiesGettextProps>(
  (props, ref) => (
...
ActivitiesGettext.displayName = 'ActivitiesGettext';

export default ActivitiesGettext;
