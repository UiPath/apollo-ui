...
export interface BpmnEndEventSignalCatchProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const BpmnEndEventSignalCatch = React.forwardRef<SVGSVGElement, BpmnEndEventSignalCatchProps>(
  ({ size, ...props }, ref) => (
