  ...
  ({ size, ...props }, ref) => (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4.22223 19.7778V2H2V22H22V19.7778H4.22223ZM20.042 8.93078L15.439 14.1092L11.5027 10.7353L7.23029 15.0077L5.65894 13.4364L11.3865 7.70883L15.2281 11.0016L18.4679 7.35672L16.4446 5.33335H22.0001V10.8889L20.042 8.93078Z"
        fill="currentColor"
      />
    </svg>
  )
