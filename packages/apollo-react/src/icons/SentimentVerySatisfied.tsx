// Auto-generated from social/sentiment-very-satisfied.svg
import React from 'react';

export interface SentimentVerySatisfiedProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const SentimentVerySatisfied = React.forwardRef<SVGSVGElement, SentimentVerySatisfiedProps>(
  ({ size, ...props }, ref) => (
