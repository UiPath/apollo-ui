...
export interface TakeScreenshotProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const TakeScreenshot = React.forwardRef<SVGSVGElement, TakeScreenshotProps>(
  ({ size, ...props }, ref) => (
...
TakeScreenshot.displayName = 'TakeScreenshot';
