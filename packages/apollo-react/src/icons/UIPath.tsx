// Auto-generated from third-party/ui-path.svg
import React from 'react';

export interface UIPathProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const UIPath = React.forwardRef<SVGSVGElement, UIPathProps>(({ size, ...props }, ref) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
