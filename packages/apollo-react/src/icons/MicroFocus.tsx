...
export const MicroFocus = React.forwardRef<SVGSVGElement, MicroFocusProps>(
  (props, ref) => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" ref={ref} {...props}>
      <path fillRule="evenodd" clipRule="evenodd" d="M20.9996 17.5044V3H6.49512V6.49557H3V21H17.5044V17.5044H20.9996ZM17.5039 17.5043H6.49567V6.49567H17.5039V17.5043Z" fill="#0075F3"/>
    </svg>
  )
);
