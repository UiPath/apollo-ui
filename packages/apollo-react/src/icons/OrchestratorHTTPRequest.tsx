...
export interface OrchestratorHTTPRequestProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const OrchestratorHTTPRequest = React.forwardRef<SVGSVGElement, OrchestratorHTTPRequestProps>(
  ({ size, ...props }, ref) => (
