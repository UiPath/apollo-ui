// Auto-generated from activities/activities-take-screenshot.svg
import React from 'react';

export interface ActivitiesTakeScreenshotProps extends React.SVGProps<SVGSVGElement> {}

export const ActivitiesTakeScreenshot = React.forwardRef<SVGSVGElement, ActivitiesTakeScreenshotProps>(
  (props, ref) => (
...
ActivitiesTakeScreenshot.displayName = 'ActivitiesTakeScreenshot';

export default ActivitiesTakeScreenshot;
