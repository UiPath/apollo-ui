// Auto-generated from activities/category-queues-icon-wait-queue-item.svg
import React from 'react';

export interface CategoryQueuesIconWaitQueueItemProps extends React.SVGProps<SVGSVGElement> {}

export const CategoryQueuesIconWaitQueueItem = React.forwardRef<SVGSVGElement, CategoryQueuesIconWaitQueueItemProps>(
  (props, ref) => (
...
CategoryQueuesIconWaitQueueItem.displayName = 'CategoryQueuesIconWaitQueueItem';

export default CategoryQueuesIconWaitQueueItem;
