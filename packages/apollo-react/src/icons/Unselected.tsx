// Auto-generated from check-box/unselected.svg
import React from 'react';

export interface UnselectedProps extends React.SVGProps<SVGSVGElement> {}

export const Unselected = React.forwardRef<SVGSVGElement, UnselectedProps>(
  (props, ref) => (
