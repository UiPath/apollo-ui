// Auto-generated from data-type/array.svg
import React from 'react';

export interface ArrayProps extends React.SVGProps<SVGSVGElement> {}

export const Array = React.forwardRef<SVGSVGElement, ArrayProps>(
  (props, ref) => (
