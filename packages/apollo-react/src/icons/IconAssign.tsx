// Auto-generated from activities/icon-assign.svg
import React from 'react';

export interface IconAssignProps extends React.SVGProps<SVGSVGElement> {}

export const IconAssign = React.forwardRef<SVGSVGElement, IconAssignProps>(
  (props, ref) => (
...
IconAssign.displayName = 'IconAssign';
