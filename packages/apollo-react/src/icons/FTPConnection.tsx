// Auto-generated from object/ftp-connection.svg
import React from 'react';

export interface FTPConnectionProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const FTPConnection = React.forwardRef<SVGSVGElement, FTPConnectionProps>(
  ({ size, ...props }, ref) => (
...
FTPConnection.displayName = 'FTPConnection';
