// Auto-generated from classic-icons/icon-clipboard.svg
import React from 'react';

export interface IconClipboardProps extends React.SVGProps<SVGSVGElement> {}

export const IconClipboard = React.forwardRef<SVGSVGElement, IconClipboardProps>(
  (props, ref) => (
