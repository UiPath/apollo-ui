// Auto-generated from studio-icons/create-folder.svg
import React from 'react';

export interface CreateFolderProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const CreateFolder = React.forwardRef<SVGSVGElement, CreateFolderProps>(
  ({ size, ...props }, ref) => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
