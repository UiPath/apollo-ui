...
export interface MouseClickProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const MouseClick = React.forwardRef<SVGSVGElement, MouseClickProps>(
  ({ size, ...props }, ref) => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
MouseClick.displayName = 'MouseClick';
