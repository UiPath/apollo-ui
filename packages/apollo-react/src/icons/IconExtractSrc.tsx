// Auto-generated from classic-icons/icon-extract-src.svg
import React from 'react';

export interface IconExtractSrcProps extends React.SVGProps<SVGSVGElement> {}

export const IconExtractSrc = React.forwardRef<SVGSVGElement, IconExtractSrcProps>(
  (props, ref) => (
...
IconExtractSrc.displayName = 'IconExtractSrc';

export default IconExtractSrc;
