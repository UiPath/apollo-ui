...
export interface ConfigurationPanelDynamicValuesProps
...
export const ConfigurationPanelDynamicValues = React.forwardRef<
  SVGSVGElement,
  ConfigurationPanelDynamicValuesProps
>(({ size, ...props }, ref) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
