// Auto-generated from icon-stage.svg
import React from 'react';

export interface IconStageProps extends React.SVGProps<SVGSVGElement> {}

export const IconStage = React.forwardRef<SVGSVGElement, IconStageProps>(
  (props, ref) => (
...
IconStage.displayName = 'IconStage';
