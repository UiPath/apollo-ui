...
export interface BpmnGatewayExclusiveProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
<path d="M8.00002 9.06066L9.06068 8L16.1318 15.0711L15.0711 16.1317L8.00002 9.06066Z" fill="currentColor"/>
<path d="M15.0711 8L16.1318 9.06066L9.06068 16.1317L8.00002 15.0711L15.0711 8Z" fill="currentColor"/>
    </svg>
  )
);
