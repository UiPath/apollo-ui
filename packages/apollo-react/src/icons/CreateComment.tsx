...
export interface CreateCommentProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
<path d="M2 4C2 2.9 2.9 2 4 2H20C21.1 2 22 2.9 22 4V13H20V4H4V17.17L5.17 16H13V18H6L2 22V4Z" fill="currentColor"/>
    </svg>
  )
);
