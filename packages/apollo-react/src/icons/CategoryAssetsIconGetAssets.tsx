// Auto-generated from activities/category-assets-icon-get-assets.svg
import React from 'react';

export interface CategoryAssetsIconGetAssetsProps extends React.SVGProps<SVGSVGElement> {}

export const CategoryAssetsIconGetAssets = React.forwardRef<SVGSVGElement, CategoryAssetsIconGetAssetsProps>(
  (props, ref) => (
...
CategoryAssetsIconGetAssets.displayName = 'CategoryAssetsIconGetAssets';

export default CategoryAssetsIconGetAssets;
