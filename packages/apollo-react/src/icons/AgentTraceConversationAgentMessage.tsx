...
export interface AgentTraceConversationAgentMessageProps extends React.SVGProps<SVGSVGElement> {}

export const AgentTraceConversationAgentMessage = React.forwardRef<SVGSVGElement, AgentTraceConversationAgentMessageProps>(
  (props, ref) => (
