...
export interface OrchestratorAddQueueItemProps
...
export const OrchestratorAddQueueItem = React.forwardRef<
  SVGSVGElement,
  OrchestratorAddQueueItemProps
>(({ size, ...props }, ref) => (
  <svg
    viewBox="0 0 24 25"
    fill="none"
...
OrchestratorAddQueueItem.displayName = 'OrchestratorAddQueueItem';

export default OrchestratorAddQueueItem;
