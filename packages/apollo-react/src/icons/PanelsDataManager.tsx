...
export interface PanelsDataManagerProps
...
export const PanelsDataManager = React.forwardRef<SVGSVGElement, PanelsDataManagerProps>(
  ({ size, ...props }, ref) => (
    ...
    >
      ...
      <defs>
        <clipPath id="clip0_4117_2329">
          <rect width="24" height="24" fill="var(--color-foreground)" />
        </clipPath>
        <clipPath id="clip1_4117_2329">
          <rect width="24" height="24" fill="var(--color-foreground)" />
        </clipPath>
      </defs>
    </svg>
...
PanelsDataManager.displayName = 'PanelsDataManager';

export default PanelsDataManager;
