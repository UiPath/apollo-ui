...
export interface OrchestratorWaitQueueItemProps
...
export const OrchestratorWaitQueueItem = React.forwardRef<
  SVGSVGElement,
  OrchestratorWaitQueueItemProps
>(({ size, ...props }, ref) => (
  <svg
    viewBox="0 0 24 25"
    fill="none"
