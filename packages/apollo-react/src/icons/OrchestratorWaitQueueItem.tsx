// Auto-generated from studio-activities-icon-sets/activities-orchestrator/orchestrator-wait-queue-item.svg
import React from 'react';

export interface OrchestratorWaitQueueItemProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const OrchestratorWaitQueueItem = React.forwardRef<SVGSVGElement, OrchestratorWaitQueueItemProps>(
  ({ size, ...props }, ref) => (
...
OrchestratorWaitQueueItem.displayName = 'OrchestratorWaitQueueItem';

export default OrchestratorWaitQueueItem;
