// Auto-generated from toggle/toggle/toggle-on.svg
import React from 'react';

export interface ToggleOnProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
