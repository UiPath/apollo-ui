...
export interface Filter9PlusProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const Filter9Plus = React.forwardRef<SVGSVGElement, Filter9PlusProps>(
  ({ size, ...props }, ref) => (
