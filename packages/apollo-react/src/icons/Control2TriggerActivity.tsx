...
export interface Control2TriggerActivityProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const Control2TriggerActivity = React.forwardRef<SVGSVGElement, Control2TriggerActivityProps>(
  ({ size, ...props }, ref) => (
