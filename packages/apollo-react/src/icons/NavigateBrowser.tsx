...
export interface NavigateBrowserProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const NavigateBrowser = React.forwardRef<SVGSVGElement, NavigateBrowserProps>(
  ({ size, ...props }, ref) => (
...
NavigateBrowser.displayName = 'NavigateBrowser';

export default NavigateBrowser;
