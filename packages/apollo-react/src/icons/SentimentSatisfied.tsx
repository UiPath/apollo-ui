// Auto-generated from social/sentiment-satisfied.svg
import React from 'react';

export interface SentimentSatisfiedProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const SentimentSatisfied = React.forwardRef<SVGSVGElement, SentimentSatisfiedProps>(
  ({ size, ...props }, ref) => (
