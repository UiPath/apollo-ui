// Auto-generated from logic/switch.svg
import React from 'react';

export interface SwitchProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const Switch = React.forwardRef<SVGSVGElement, SwitchProps>(
  ({ size, ...props }, ref) => (
