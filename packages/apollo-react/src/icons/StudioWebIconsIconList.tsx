// Auto-generated from studio-web-icons/icon-list.svg
import React from 'react';

export interface StudioWebIconsIconListProps extends React.SVGProps<SVGSVGElement> {}

export const StudioWebIconsIconList = React.forwardRef<SVGSVGElement, StudioWebIconsIconListProps>(
  (props, ref) => (
...
StudioWebIconsIconList.displayName = 'StudioWebIconsIconList';

export default StudioWebIconsIconList;
