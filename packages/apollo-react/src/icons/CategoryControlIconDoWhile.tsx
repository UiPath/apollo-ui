// Auto-generated from activities/category-control-icon-do-while.svg
import React from 'react';

export interface CategoryControlIconDoWhileProps extends React.SVGProps<SVGSVGElement> {}

export const CategoryControlIconDoWhile = React.forwardRef<SVGSVGElement, CategoryControlIconDoWhileProps>(
  (props, ref) => (
...
CategoryControlIconDoWhile.displayName = 'CategoryControlIconDoWhile';

export default CategoryControlIconDoWhile;
