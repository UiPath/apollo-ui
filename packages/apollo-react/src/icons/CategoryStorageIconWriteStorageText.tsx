// Auto-generated from activities/category-storage-icon-write-storage-text.svg
import React from 'react';

export interface CategoryStorageIconWriteStorageTextProps extends React.SVGProps<SVGSVGElement> {}

export const CategoryStorageIconWriteStorageText = React.forwardRef<SVGSVGElement, CategoryStorageIconWriteStorageTextProps>(
  (props, ref) => (
...
CategoryStorageIconWriteStorageText.displayName = 'CategoryStorageIconWriteStorageText';

export default CategoryStorageIconWriteStorageText;
