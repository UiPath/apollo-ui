...
export interface Control1AppendLineProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const Control1AppendLine = React.forwardRef<SVGSVGElement, Control1AppendLineProps>(
  ({ size, ...props }, ref) => (
    <svg viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" ref={ref} {...props} width={size ?? 25} height={size ?? 25}>
      <path d="M6.27735 2.23535H14.2774L20.2774 8.23535V13.2354H18.2774V9.23535H13.2774V4.23535H6.27735L6.27742 12.2354H4.2793L4.28735 4.23535C4.28735 3.13535 5.17735 2.23535 6.27735 2.23535Z" fill="currentColor"/>
