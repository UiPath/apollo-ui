...
export interface FTPDeleteFileOrFolderProps extends React.SVGProps<SVGSVGElement> {}
...
FTPDeleteFileOrFolder.displayName = 'FTPDeleteFileOrFolder';

export default FTPDeleteFileOrFolder;
