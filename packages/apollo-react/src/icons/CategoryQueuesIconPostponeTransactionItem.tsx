// Auto-generated from activities/category-queues-icon-postpone-transaction-item.svg
import React from 'react';

export interface CategoryQueuesIconPostponeTransactionItemProps extends React.SVGProps<SVGSVGElement> {}

export const CategoryQueuesIconPostponeTransactionItem = React.forwardRef<SVGSVGElement, CategoryQueuesIconPostponeTransactionItemProps>(
  (props, ref) => (
...
CategoryQueuesIconPostponeTransactionItem.displayName = 'CategoryQueuesIconPostponeTransactionItem';

export default CategoryQueuesIconPostponeTransactionItem;
