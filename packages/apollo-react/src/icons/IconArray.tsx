// Auto-generated from studio-web-icons/icon-array.svg
import React from 'react';

export interface IconArrayProps extends React.SVGProps<SVGSVGElement> {}

export const IconArray = React.forwardRef<SVGSVGElement, IconArrayProps>(
  (props, ref) => (
...
IconArray.displayName = 'IconArray';
