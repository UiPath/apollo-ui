...
export interface Control1RemoveLogFieldsProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const Control1RemoveLogFields = React.forwardRef<SVGSVGElement, Control1RemoveLogFieldsProps>(
  ({ size, ...props }, ref) => (
