// Auto-generated from action/thumb-up.svg
import React from 'react';

export interface ThumbUpProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const ThumbUp = React.forwardRef<SVGSVGElement, ThumbUpProps>(({ size, ...props }, ref) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
