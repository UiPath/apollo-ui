...
export interface OrchestratorSetTransactionStatusProps
...
export const OrchestratorSetTransactionStatus = React.forwardRef<
  SVGSVGElement,
  OrchestratorSetTransactionStatusProps
>(({ size, ...props }, ref) => (
  <svg
    viewBox="0 0 24 25"
    fill="none"
