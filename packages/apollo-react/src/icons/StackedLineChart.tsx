...
export interface StackedLineChartProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const StackedLineChart = React.forwardRef<SVGSVGElement, StackedLineChartProps>(
  ({ size, ...props }, ref) => (
