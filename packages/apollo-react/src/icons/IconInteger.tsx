// Auto-generated from studio-web-icons/icon-integer.svg
import React from 'react';

export interface IconIntegerProps extends React.SVGProps<SVGSVGElement> {}

export const IconInteger = React.forwardRef<SVGSVGElement, IconIntegerProps>(
  (props, ref) => (
...
IconInteger.displayName = 'IconInteger';

export default IconInteger;
