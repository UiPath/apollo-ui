// Auto-generated from update-row-item.svg
import React from 'react';

export interface IconUpdateRowItemProps extends React.SVGProps<SVGSVGElement> {}

export const IconUpdateRowItem = React.forwardRef<SVGSVGElement, IconUpdateRowItemProps>(
  (props, ref) => (
...
IconUpdateRowItem.displayName = 'IconUpdateRowItem';

export default IconUpdateRowItem;
