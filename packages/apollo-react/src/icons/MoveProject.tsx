// Auto-generated from studio-icons/move-project.svg
import React from 'react';

export interface MoveProjectProps extends Omit<React.SVGProps<SVGSVGElement>, 'width' | 'height'> {
  /**
...
export const MoveProject = React.forwardRef<SVGSVGElement, MoveProjectProps>(
  ({ size, ...props }, ref) => (
...
MoveProject.displayName = 'MoveProject';
