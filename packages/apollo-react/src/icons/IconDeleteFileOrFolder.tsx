// Auto-generated from activities/icon-delete-file-or-folder.svg
import React from 'react';

export interface IconDeleteFileOrFolderProps extends React.SVGProps<SVGSVGElement> {}

export const IconDeleteFileOrFolder = React.forwardRef<SVGSVGElement, IconDeleteFileOrFolderProps>(
  (props, ref) => (
...
IconDeleteFileOrFolder.displayName = 'IconDeleteFileOrFolder';

export default IconDeleteFileOrFolder;
