...
interface FlexProps {
  /** Alignment of items along cross axis (horizontal for column) */
  align?: keyof typeof alignMap;
  /** Justification of items along main axis (vertical for column) */
...
/**
 * Flexible column layout component with comprehensive flexbox API
 *
 * @example
 * ```tsx
 * // Basic usage
 ...
 *
 * // With spacing
 * <Column p={16} m={8} spaceBetween fullHeight>
 *   <h2>Header</h2>
 *   <div>Content</div>
