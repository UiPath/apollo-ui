...
describe('cx utility function', () => {
  ...
  it('should handle mixed types', () => {
    expect(cx('class1', { class2: true, class3: false }, ['class4', { class5: true }])).toBe(
  ...
  it('should handle deeply nested arrays and objects', () => {
    expect(
      cx(['class1', ['class2', { class3: true, class4: false }, ['class5', { class6: true }]]])
    ).toBe('class1 class2 class3 class5 class6');
  });
