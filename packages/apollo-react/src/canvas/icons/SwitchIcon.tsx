export const SwitchIcon = ({ w = 48, h = 48 }: { w?: number | string; h?: number | string }) => {
  return (
    <svg width={w} height={h} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        fill="currentcolor"
      />
      <path d="M9 4H5V7H9V4Z" fill="var(--color-background)" />
      <path d="M9 17H5V20H9V17Z" fill="currentcolor" />
      <path d="M19 17H15V20H19V17Z" fill="var(--color-background)" />
    </svg>
  );
};
