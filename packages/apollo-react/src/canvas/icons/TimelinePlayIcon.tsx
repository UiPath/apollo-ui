export const TimelinePlayIcon = ({ w = 24, h = 25, color = "#526069" }: { w?: number | string; h?: number | string; color?: string }) => {
  return (
    <svg data-testid="timeline-play-icon" xmlns="http://www.w3.org/2000/svg" width={w} height={h} viewBox="0 0 24 25" fill="none">
      <path
