...
export const CanvasPositionControls = memo(
  ({ orientation = "horizontal", fitViewOptions, translations, showOrganize = true }: CanvasPositionControlsProps) => {
    ...
    return (
      <RootComponent data-testid="canvas-controls">
        {showOrganize && (
          <ApTooltip content={translations.organize} placement={placement} data-testid="organize-button">
        ...
        <ApTooltip content={translations.zoomOut} placement={placement} data-testid="zoom-out-button">
          <ApIconButton color="secondary" onClick={handleZoomOut}>
            <Icons.ZoomOutIcon />
          </ApIconButton>
        </ApTooltip>
        <ApTooltip content={translations.zoomToFit} placement={placement} data-testid="fit-to-view-button">
