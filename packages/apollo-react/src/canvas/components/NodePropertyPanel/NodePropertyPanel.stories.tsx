...
function Concept2PanelStory({
  ...
  const NODE_MODES = [
    ...
    },
    {
      value: 'llm',
      label: 'AI Mock',
      description: 'Generate a response automatically, from instructions',
      dot: 'bg-purple-500',
      ...
      >
        <div className="flex h-full min-h-0 flex-col">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-64">
                    {NODE_MODES.map((m) => (
                      ...
                      >
                        <span className={cn('mt-[3px] size-1.5 shrink-0 rounded-full', m.dot)} />
          ...
          <Tabs defaultValue="schema" className="flex min-h-0 flex-1 flex-col">
            ...
            <div className={cn('shrink-0 flex items-center gap-2 px-[0.875rem] pb-1.5', context === 'studio' && 'pt-3')}>
              <TabsList className={TAB_LIST_CLASS}>
            ...
            <TabsContent value="schema" className="mt-0 flex min-h-0 flex-1 flex-col">
              ...
              <div className="shrink-0 flex items-center gap-1.5 px-[0.875rem] pb-1 pt-2">
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button
                      type="button"
                      className="flex shrink-0 items-center gap-1.5 rounded-md px-2 py-1 text-xs font-medium text-foreground-muted transition hover:bg-surface-overlay hover:text-foreground"
                    >
                      <span>
                        {filter === 'referenced'
                        ...
                        {editingPath === node.path ? (
                          ...
                          <>
                            ...
                            <button
                              ...
                              className="grid size-5 shrink-0 place-items-center rounded text-foreground-subtle opacity-0 transition hover:bg-surface-raised hover:text-foreground group-hover:opacity-100 focus-visible:opacity-100"
                            >
