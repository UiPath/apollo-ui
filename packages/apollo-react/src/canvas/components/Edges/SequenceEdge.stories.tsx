...
function DefaultStory() {
  const initialNodes = useMemo(
    () => [
      ...
      createNode({ id: "bottom", label: "Bottom", x: 300, y: 470, sourcePositions: [Position.Top] }),
      ...
      // Preview Section
      createStickyNote("sticky-preview", "blue", "**Preview**\nDashed primary color", { x: 760, y: 80 }, { width: 420, height: 200 }),
      createNode({ id: "preview-source", label: "Preview", x: 800, y: 150, sourcePositions: [Position.Right] }),
      createNode({ id: "preview-target", label: "Target", x: 1020, y: 150, targetPositions: [Position.Left] }),

      // Diff States Section
      createStickyNote("sticky-diff", "white", "**Diff States**\nFor version comparison", { x: 760, y: 330 }, { width: 420, height: 340 }),
      createNode({ id: "added-source", label: "Added", x: 800, y: 410, sourcePositions: [Position.Right] }),
      createNode({ id: "added-target", label: "Target", x: 1020, y: 410, targetPositions: [Position.Left] }),
      createNode({ id: "removed-source", label: "Removed", x: 800, y: 530, sourcePositions: [Position.Right] }),
      createNode({ id: "removed-target", label: "Target", x: 1020, y: 530, targetPositions: [Position.Left] }),
