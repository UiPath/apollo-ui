...
export const edgeTargetStatusToEdgeColor: { [key in ElementStatus | ValidationErrorSeverity]: string } = {
...
export const getStatusAnimation = (status: ElementStatus | ValidationErrorSeverity | undefined, edgePath: string) => {
