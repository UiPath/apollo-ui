    ...
    return (
      <div
        ...
        className={cn(
          ...
          // horizontal padding so the tint extends past the content without moving it; vertically
          // it keeps the padding and not the margin, so the highlight has some height of its own
