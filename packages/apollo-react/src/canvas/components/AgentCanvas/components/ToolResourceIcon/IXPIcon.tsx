...
export const IxpIcon = ({
  ...
  return (
    <svg fill="none" height={height} viewBox="0 0 24 24" width={width} xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform={variant === "filled" ? "translate(12, 12) scale(0.7) translate(-12, -12)" : undefined}>
        {/* Document shape */}
        <path
        ...
        />
        {/* Folded corner */}
        <path d="M12 2V8C12 8.55228 12.4477 9 13 9H19" stroke={iconPrimaryColor} strokeWidth="1.5" fill="none" />
