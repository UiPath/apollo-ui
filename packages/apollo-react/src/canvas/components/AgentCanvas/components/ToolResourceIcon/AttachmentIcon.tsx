...
export const AttachmentIcon = ({ width = 24, height = 24, color = "#526069", className }: AttachmentIconProps) => {
  return (
    <BaseIcon width={width} height={height} viewBox="0 0 24 24" className={className} testId="attachment-icon">
      <path
