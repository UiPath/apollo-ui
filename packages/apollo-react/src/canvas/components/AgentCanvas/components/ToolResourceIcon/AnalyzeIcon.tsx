...
export const AnalyzeIcon = ({ width = 24, height = 24, color = "#526069", className }: AnalyzeIconProps) => {
  return (
    <BaseIcon width={width} height={height} viewBox="0 0 24 24" className={className} testId="analyze-icon">
      <path
