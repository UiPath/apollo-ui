      ...
      },
      {
        ...
        data: {
          ...
          execution: {
            ...
            taskStatus: {
              "1": { status: "Completed", label: "Liability Check", duration: "1h 30m", badge: "Reworked", retryCount: 2 },
              "2": { status: "Completed", label: "Credit Review", duration: "1h 30m", badge: "Reworked", retryCount: 1 },
              "3": { status: "Completed", label: "Address Verification", duration: "30m" },
              "4": { status: "Completed", label: "Property Verification", duration: "1h 30m", badge: "Reworked", retryCount: 3 },
