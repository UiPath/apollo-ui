...
describe("ButtonHandles", () => {
  ...
  it("should not apply bottom positioning when handles are only at left and right", () => {
    const leftHandles: ButtonHandleConfig[] = [{ id: "left-handle", type: "target", handleType: "input" }];
    const rightHandles: ButtonHandleConfig[] = [{ id: "right-handle", type: "source", handleType: "output" }];
  ...
  describe("Grid-aligned positioning", () => {
    it("uses grid-aligned positioning for Top handles when nodeWidth is provided", () => {
      ...
      render(<ButtonHandles handles={handles} nodeId="test-node" position={Position.Top} nodeWidth={120} />);
    ...
    it("uses grid-aligned positioning for Left handles when nodeHeight is provided", () => {
      ...
      render(<ButtonHandles handles={handles} nodeId="test-node" position={Position.Left} nodeHeight={120} />);
    ...
    it("uses nodeWidth for Top/Bottom positions, not nodeHeight", () => {
      ...
      render(<ButtonHandles handles={handles} nodeId="test-node" position={Position.Top} nodeWidth={160} nodeHeight={80} />);
    ...
    it("uses nodeHeight for Left/Right positions, not nodeWidth", () => {
      const handles: ButtonHandleConfig[] = [{ id: "handle1", type: "target", handleType: "input" }];

      // Provide both dimensions - Left position should use nodeHeight
      render(<ButtonHandles handles={handles} nodeId="test-node" position={Position.Left} nodeWidth={160} nodeHeight={80} />);
