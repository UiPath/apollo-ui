...
const createToggleButtonNodeRegistration = (onToggle: (nodeId: string, actionId: string, newState: boolean) => void): NodeRegistration => ({
  nodeType: "toggleDemo",
  category: "demo",
...
const createCustomColorNodeRegistration = (onToggle: (nodeId: string, actionId: string, newState: boolean) => void): NodeRegistration => ({
          ...
          (nodeId: string, actionId: string, newState: boolean) => {
            setNodes((nodes) =>
              nodes.map((node) => {
                ...
                const paramKey = actionId === "visibility" ? "visibilityOn" : actionId === "lock" ? "lockOn" : `${actionId}On`;
                return {
                  ...node,
                  data: {
                    ...nodeData,
...
function createToolbarNodes(position: "top" | "bottom" | "left" | "right" = "top"): Node<BaseNodeData>[] {
