...
describe('ApTypography', () => {
  describe('Basic Rendering', () => {
    ...
    it('renders with specified variant', () => {
      render(<ApTypography variant={FontVariantToken.fontSizeL}>Large Text</ApTypography>);
  ...
  describe('Heading Variants', () => {
    it('renders h1 for fontSizeH1 variant', () => {
      render(<ApTypography variant={FontVariantToken.fontSizeH1}>Heading 1</ApTypography>);
    ...
    it('renders h2 for fontSizeH2 variant', () => {
      render(<ApTypography variant={FontVariantToken.fontSizeH2}>Heading 2</ApTypography>);
    ...
    it('renders h3 for fontSizeH3 variant', () => {
      render(<ApTypography variant={FontVariantToken.fontSizeH3}>Heading 3</ApTypography>);
    ...
    it('renders h4 for fontSizeH4 variant', () => {
      render(<ApTypography variant={FontVariantToken.fontSizeH4}>Heading 4</ApTypography>);
    ...
    it('renders h1 for hero variants', () => {
      render(<ApTypography variant={FontVariantToken.fontSizeHero}>Hero Text</ApTypography>);
      const heading = screen.getByRole('heading', { level: 1 });
      expect(heading).toBeInTheDocument();
      expect(heading.tagName).toBe('H1');
    });
  ...
  describe('Body Text Variants', () => {
    it('renders p tag for large body text', () => {
      render(<ApTypography variant={FontVariantToken.fontSizeL}>Body Large</ApTypography>);
      const element = screen.getByText('Body Large');
      expect(element.tagName).toBe('P');
    });

    it('renders span for medium body text', () => {
      render(<ApTypography variant={FontVariantToken.fontSizeM}>Body Medium</ApTypography>);
      const element = screen.getByText('Body Medium');
      expect(element.tagName).toBe('SPAN');
    });

    it('renders span for small text', () => {
      render(<ApTypography variant={FontVariantToken.fontSizeS}>Small Text</ApTypography>);
  ...
  describe('Monospace Variants', () => {
    it('renders code tag for monospace variants', () => {
      render(<ApTypography variant={FontVariantToken.fontMonoM}>Code Text</ApTypography>);
  ...
  describe('Color Prop', () => {
    it('accepts custom color prop', () => {
      render(<ApTypography color="#FF5722">Colored Text</ApTypography>);
      const element = screen.getByText('Colored Text');
      expect(element).toBeInTheDocument();
    });

    it('accepts CSS variable color prop', () => {
      render(<ApTypography color="var(--color-primary)">Variable Color</ApTypography>);
  ...
  describe('MUI Props Pass-through', () => {
    it('passes className prop', () => {
      render(<ApTypography className="custom-class">Custom Class</ApTypography>);
      const element = screen.getByText('Custom Class');
      expect(element).toHaveClass('custom-class');
    });

    it('passes data attributes', () => {
      render(<ApTypography data-testid="custom-typography">Test ID</ApTypography>);
      expect(screen.getByTestId('custom-typography')).toBeInTheDocument();
    });

    it('accepts sx prop', () => {
      render(<ApTypography sx={{ marginTop: 2 }}>SX Prop</ApTypography>);
  ...
  describe('Typography Tokens', () => {
    it('renders with Apollo typography variant', () => {
      render(<ApTypography variant={FontVariantToken.fontSizeM}>Token Text</ApTypography>);
    ...
    it('renders heading with correct variant', () => {
      render(<ApTypography variant={FontVariantToken.fontSizeH1}>Large Heading</ApTypography>);
  ...
  describe('Component Override', () => {
    it('allows component override via prop', () => {
      render(<ApTypography component="div">Div Component</ApTypography>);
