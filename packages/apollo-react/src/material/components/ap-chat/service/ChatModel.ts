...
/**
 * Represents a custom header action in the Autopilot Chat header.
 *
 * @property id - Unique identifier for the action
 * @property name - Display name of the action
 * @property description - Optional description shown in tooltip
 * @property icon - Optional icon name for the action
 * @property children - Optional nested actions (only 1 level deep - children cannot have
 *                       children)
 ...
 *
 * @property id - Unique identifier for the message. Automatically generated by the chat
 *                 service if not provided.
 * @property content - The text content of the message.
 * @property created_at - Timestamp when the message was created (generated by the chat
 *                        service for requests)
 * @property role - Indicates whether the message is from the user or assistant. Set
 *                  automatically to AutopilotChatRole.User for sendRequest and
 *                  AutopilotChatRole.Assistant for sendResponse.
 ...
 * @property hijacked - Flag set by the chat service when an event is intercepted and the
 *                      interceptor returns true
 * @property fakeStream - Temporary flag used to simulate streaming for a complete message
 *                        (will be ignored for requests)
 * @property stream - Flag used to stream a chunk (will be ignored for requests)
 * @property done - Flag to determine if the message is the last chunk of a streaming
 *                  response
 * @property actions - Additional actions on top of DefaultAutopilotChatResponseAction
 *                     (for responses) and DefaultAutopilotChatRequestAction (for requests)
 ...
 * @property meta - Optional metadata for the message (additional information about the
 *                   message)
 * @property toCopy - Optional string to copy when the message is copied
 * @property shouldWaitForMoreMessages - Optional flag to indicate if the chat service
 ...
 *                                   (old version, should not be used, will be deprecated)
 * @property {string} SetAttachments - Emitted when the attachments are set in the prompt
 *                                     (added and removed array)
 * @property {string} SetSelectedAgentMode - Emitted when the agent mode is selected
 *                                           (agent | plan | execute)
 ...
 * @property {string} ShouldShowLoadingMoreMessages - Emitted when loading more messages
 *                                                     should be shown
 * @property {string} PrependOlderMessages - Emitted when older messages are prepended to
 *                                           the conversation
 * @property {string} ShowLoadingState - Emitted when the loading state should be shown
 * @property {string} SetWaiting - Emitted when the waiting state should be set for the
 *                                  prompt box
 ...
 * @property showInOverflow - Whether the action should be shown in the overflow menu
...
/**
 * Arguments for an input activity start event. An activity start event must be sent before
 * sending media chunks. An activity end event should be sent after all media chunks have
 * been sent.
 */
