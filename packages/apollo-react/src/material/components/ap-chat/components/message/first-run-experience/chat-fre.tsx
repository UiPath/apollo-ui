...
function AutopilotChatFREComponent() {
  const { firstRunExperience, spacing } = useChatState();
  ...
  return (
    <FREContainer>
      <FREHeader>
        <ApTypography variant={spacing.titleFontToken} color={'var(--color-foreground)'}>
          {firstRunExperience.title}
        </ApTypography>
        <ApTypography variant={spacing.primaryFontToken} color={'var(--color-foreground-de-emp)'}>
