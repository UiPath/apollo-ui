...
const AutopilotChatSettingsHeaderComponent: React.FC<{
  ...
  const handleCloseSettings = React.useCallback(() => {
    ...
    chatService
      .getPreHook(AutopilotChatPreHookAction.ToggleHistory)({ settingsOpen: isSettingsOpen })
      .then((proceed) => {
        if (!proceed) {
          return;
        }
    ...
    <HeaderContainer>
      ...
      <ActionsContainer>
        <AutopilotChatActionButton
          ...
          tooltip={
            isSettingsOpen
              ? _(msg({ id: 'autopilot-chat.settings.hide', message: `Hide settings` }))
              : ''
          }
          ariaLabel={
            isSettingsOpen
