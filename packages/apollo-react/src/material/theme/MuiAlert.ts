...
export const MuiAlert = (palette: Palette) => {
    return {
        root: {
            ...
            '&.MuiAlert-standardWarning > .MuiAlert-icon': { color: palette.semantic.colorWarningIcon },
            '&.MuiAlert-standardInfo > .MuiAlert-icon': { color: palette.semantic.colorInfoIcon },
            '&.MuiAlert-standardError > .MuiAlert-icon': { color: palette.semantic.colorErrorIcon },
            '&.MuiAlert-standardSuccess > .MuiAlert-icon': { color: palette.semantic.colorSuccessIcon },
            '& .MuiAlert-icon': {
                fontSize: '36px',
                padding: 0,
                marginRight: '20px',
