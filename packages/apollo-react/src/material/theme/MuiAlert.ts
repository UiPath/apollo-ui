...
export const MuiAlert = (palette: Palette) => ({
    root: {
        ...
        '&.MuiAlert-standardWarning > .MuiAlert-icon': { color: palette.semantic.colorWarningIconInverse },
        ...
        '&.MuiAlert-standardSuccess > .MuiAlert-icon': { color: palette.semantic.colorSuccessIconInverse },
        '& .MuiAlert-icon': {
            fontSize: '36px',
            padding: 0,
            marginRight: '20px',
