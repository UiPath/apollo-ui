...
export const MuiAlert = (palette: Palette) => {
    return {
        root: {
            ...
            '&.MuiAlert-standardWarning > .MuiAlert-icon': { color: palette.semantic.colorWarningForegroundInverse },
            '&.MuiAlert-standardInfo > .MuiAlert-icon': { color: palette.semantic.colorInfoForegroundInverse },
            '&.MuiAlert-standardError > .MuiAlert-icon': { color: palette.semantic.colorErrorForegroundInverse },
            '&.MuiAlert-standardSuccess > .MuiAlert-icon': { color: palette.semantic.colorSuccessForegroundInverse },
            '& .MuiAlert-icon': {
                fontSize: '36px',
                padding: 0,
                marginRight: '20px',
