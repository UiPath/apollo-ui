...
import { buildField, type DataModelField } from '@/lib/charts-core';
import { type Entity, type EntityField, mapFieldType } from '../data-fabric/util/entities';
...
export function buildTableDataModel(entity: Entity): {
  ...
  return {
    id: entity.id,
    fields: entity.fields.map((field) => buildField(field.name, mapFieldType(field.dataType))),
  };
}
...
export function validateDimensions(dimensions: string[], validNames: Iterable<string>): string[] {
