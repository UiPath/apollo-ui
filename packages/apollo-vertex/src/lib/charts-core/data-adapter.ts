import type { QueryOptions, UseSuspenseQueryOptions } from '@tanstack/react-query';
import type {
  BarChartData,
  ChartDataModel,
  DatetimeModelField,
...
export interface DataAdapter {
  charts: {
    ...
    ) => UseSuspenseQueryOptions<TableChartData, Error, TableChartData, string[]>;
    bar: (
    ...
    ) => UseSuspenseQueryOptions<DistributionChartData, Error, DistributionChartData, string[]>;
    line: (
    ...
    multiLine: (
      ...
      dataModel: ChartDataModel<DatetimeModelField>
    ) => UseSuspenseQueryOptions<MultiLineChartData, Error, MultiLineChartData, string[]>;
    kpi: (
  ...
  filters: {
    list: (filter: ListFilter) => QueryOptions<PrimitiveValue[], Error, PrimitiveValue[]> & {
