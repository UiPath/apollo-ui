...
export function mapMetricToInsightsAggregate(metric: DataModelMetric): AggregateFragment {
  ...
  return {
    ...
    expression: {
      ...
      ...(hasFilters && expr.filters && { filters: mapFilterValuesToFragments(expr.filters) }),
    },
  };
}
