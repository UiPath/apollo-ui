...
const PrimitiveValueSchema = z.union([z.string(), z.boolean(), z.number(), z.null()]);

const ListFilterFragmentSchema = z.object({
  dimension: z.string(),
  values: z.array(PrimitiveValueSchema),
  type: z.union([z.literal('string'), z.literal('boolean'), z.literal('numeric')]),
...
const SearchFilterFragmentSchema = z.object({
  dimension: z.string(),
  pattern: z.string(),
  filterType: z.union([z.literal('default'), z.literal('startsWith'), z.literal('endsWith')]),
