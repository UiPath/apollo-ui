...
import { descriptionId, errorId, type FieldOption, fieldDescribedBy } from './field-utils';
...
function RadioGroupField({ label, description, options }: RadioGroupFieldProps) {
        ...
        {options.map((option) => {
          ...
          return (
            <Field key={option.value} orientation="horizontal">
              <RadioGroupItem value={option.value} id={itemId} onBlur={field.handleBlur} />
