...
import { StepperItemContext, type StepperItemState, useStepperContext } from './stepper-context';
...
function StepperItem({ className, step, completed, ...props }: StepperItemProps) {
