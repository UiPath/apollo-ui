...
interface AiGlowProps extends React.ComponentProps<'div'>, VariantProps<typeof aiGlowVariants> {}
...
function AiGlow({ variant = 'card', className, style, ...props }: AiGlowProps) {
        ...
        >
          <defs>
            ...
            >
              ...
              <stop offset="1" stopColor="var(--ai-glow-end)" stopOpacity="0.25" />
            </linearGradient>
            <clipPath id={clipId}>
  ...
  return (
    <div
      ...
      className={cn(aiGlowVariants({ variant }), className)}
      style={{
        backgroundImage: 'linear-gradient(120deg, var(--ai-glow-start), var(--ai-glow-end))',
