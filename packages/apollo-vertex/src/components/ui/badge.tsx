...
const badgeVariants = cva(
  'inline-flex items-center justify-center rounded-full border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden',
  {
    variants: {
      variant: {
        default: 'border-transparent bg-badge text-badge-foreground [a&]:hover:bg-badge/90',
        secondary:
    ...
    compoundVariants: [
      ...
      },
      {
        status: 'info',
        variant: 'secondary',
        class: 'border-transparent bg-info/15 dark:bg-info/25 text-info dark:text-white',
      },
      {
        status: 'info',
        variant: 'outline',
      ...
      },
      {
        status: 'warning',
        variant: 'outline',
        class: 'border-warning text-warning-foreground dark:text-warning bg-transparent',
      },
      ...
      },
      {
        status: 'success',
        variant: 'secondary',
        class: 'border-transparent bg-success/10 dark:bg-success/25 text-success dark:text-white',
      },
      {
        status: 'success',
        variant: 'outline',
      ...
      },
      {
        status: 'error',
        variant: 'outline',
        class: 'border-destructive text-destructive dark:text-destructive bg-transparent',
      },
      ...
      // ai status
      {
        status: 'ai',
        variant: 'default',
        class: 'border-transparent text-white [background-image:var(--ai-gradient-fill)]',
      },
      {
        status: 'ai',
        variant: 'secondary',
