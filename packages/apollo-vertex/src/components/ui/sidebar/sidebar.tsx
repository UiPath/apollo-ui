...
function Sidebar({
  ...
  const { isMobile, state, openMobile, setOpenMobile, sidebarWidthPx, sidebarWidthIconPx } =
    useSidebar();
  ...
  return (
    <div
      className={cn('group peer text-sidebar-foreground hidden md:block relative z-10', className)}
      data-state={state}
    ...
    >
      <motion.div
        ...
        className={cn('relative bg-transparent', 'group-data-[side=right]:rotate-180')}
      />
      <motion.div
        initial={false}
