  ...
  return (
    <div className="flex w-[320px] min-h-0 shrink-0 flex-col border-r border-border">
      <div className="px-4 pt-4 pb-2">
        <h2 className="text-xs font-bold leading-none text-muted-foreground">{t('agents')}</h2>
      </div>
...
const RunDetailsAgentItem = ({ result, selected, onSelect }: RunDetailsAgentItemProps) => {
  ...
  return (
    ...
    >
      <span className="text-sm font-semibold text-foreground">{result.ProcessName}</span>
