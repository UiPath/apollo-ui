  ...
  return (
    <div className="grid grid-cols-3 gap-4">
      <Card variant="glass" className="py-6">
        <CardHeader>
          <CardTitle className="text-base font-bold">{t('last_run_score')}</CardTitle>
        </CardHeader>
        <CardContent className="mt-auto">
          {loading ? (
            ...
            <div className="flex items-center gap-1.5">
              ...
              {lastBatch && <UserMessagesIcon messages={lastBatch.UserMessages} />}
            </div>
          )}
        </CardContent>
      </Card>
      ...
      <Card variant="glass" className="py-6">
        ...
        <CardContent className="mt-auto">
          {loading ? (
            ...
            <span className="text-3xl font-bold">
              {testsPassing == null || testsTotal == null ? '-' : `${testsPassing}/${testsTotal}`}
            </span>
          )}
        </CardContent>
      </Card>
      ...
      <Card variant="glass" className="py-6">
        ...
        <CardContent>
          {loading ? (
            ...
            <ChartContainer config={scoreTrendChartConfig} className="aspect-auto h-[100px] w-full">
